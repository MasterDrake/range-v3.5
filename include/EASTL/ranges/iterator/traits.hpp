...
#include "../iterator/access.hpp" // for iter_move, iter_swap
...
namespace ranges
{
    ...
    namespace detail
    {
        ...
        template<typename I>
        RANGES_INLINE_VAR constexpr bool has_nothrow_iter_move_v = noexcept(iter_rvalue_reference_t<I>(ranges::iter_move(eastl::declval<I &>())));
    } // namespace detail
    /// \endcond
    ...
    template<typename I>
    using size_type_t RANGES_DEPRECATED("size_type_t is deprecated.") = detail::iter_size_t<I>;
    /// \endcond
