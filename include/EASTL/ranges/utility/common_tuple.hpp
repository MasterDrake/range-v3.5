...
namespace ranges
{
    ...
    public:
        ...
        CPP_ctor(common_tuple)()( //
            noexcept( //
                meta::and_c<eastl::is_nothrow_default_constructible<Ts>::value...>::value)
                requires default_constructible<eastl::tuple<Ts...>>)
          : common_tuple::forward_tuple_interface{}
        {}
        template(typename... Us)(
            requires constructible_from<detail::args<Ts...>, detail::args<Us...>>)
        explicit common_tuple(Us &&... us) //
            noexcept(meta::and_c<eastl::is_nothrow_constructible<Ts, Us>::value...>::value)
        ...
        template(typename... Us)(
            ...
            noexcept(meta::and_c<
                     eastl::is_nothrow_constructible<Ts, Us const &>::value...>::value) //
          : common_tuple(that, meta::make_index_sequence<sizeof...(Ts)>{})
        {}
        template(typename... Us)(
            requires constructible_from<detail::args<Ts...>, detail::args<Us...>>)
            ...
            noexcept(
                meta::and_c<eastl::is_nothrow_constructible<Ts, Us>::value...>::value) //
          : common_tuple(eastl::move(that), meta::make_index_sequence<sizeof...(Ts)>{})
        {}
        template(typename... Us)(
            requires constructible_from<detail::args<Ts...>, detail::rargs<Us...>>)
        ...
        common_tuple & operator=(eastl::tuple<Us...> & that) noexcept(
        ...
        common_tuple & operator=(eastl::tuple<Us...> const & that) noexcept(
            meta::and_c<eastl::is_nothrow_assignable<Ts &, Us const &>::value...>::value)
        {
            (void)tuple_transform(base(), that, element_assign_{});
            return *this;
        }
        ...
        template(typename... Us)(
            requires eastl::is_assignable<detail::args<Ts const...> &,
                                        detail::rargs<Us...>>::value)
        common_tuple const & operator=(eastl::tuple<Us...> & that) const noexcept(
            meta::and_c<eastl::is_nothrow_assignable<Ts const &, Us &>::value...>::value)
        {
            (void)tuple_transform(base(), that, element_assign_{});
            return *this;
        }
        template(typename... Us)(
            requires eastl::is_assignable<detail::args<Ts const...> &,
                                        detail::rargs<Us const...>>::value)
        common_tuple const & operator=(eastl::tuple<Us...> const & that) const
            noexcept(meta::and_c<
                     eastl::is_nothrow_assignable<Ts const &, Us const &>::value...>::value)
        {
            (void)tuple_transform(base(), that, element_assign_{});
            return *this;
        }
        ...
        operator eastl::tuple<Us...>() const & noexcept(
            meta::and_c<eastl::is_nothrow_constructible<Us, Ts const &>::value...>::value)
        {
            return detail::to_std_tuple<Us...>(*this, meta::make_index_sequence<sizeof...(Ts)>{});
        }
        template(typename... Us)(requires constructible_from<detail::args<Us...>, detail::args<Ts...>>)
        operator eastl::tuple<Us...>() && noexcept(meta::and_c<eastl::is_nothrow_constructible<Us, Ts>::value...>::value)
        {
            return detail::to_std_tuple<Us...>(eastl::move(*this), meta::make_index_sequence<sizeof...(Ts)>{});
        }
    };
...
#define LOGICAL_OP(OP, CONCEPT)                                                    \
    ...
    template(typename... Ts, typename... Us)(                                      \
        requires and_v<CONCEPT<Ts, Us>...>)                                        \
    bool operator OP(eastl::tuple<Ts...> const & a, common_tuple<Us...> const & b)   \
    {                                                                              \
        return a OP b.base();                                                      \
    }                                                                              \
    template(typename... Ts, typename... Us)(                                      \
        requires and_v<CONCEPT<Ts, Us>...>)                                        \
    bool operator OP(common_tuple<Ts...> const & a, eastl::tuple<Us...> const & b)   \
    {                                                                              \
        return a.base() OP b;                                                      \
    }                                                                              \
    /**/
...
#undef LOGICAL_OP
    ...
    public:
        ...
        template(typename F2, typename S2)(
            ...
            noexcept(eastl::is_nothrow_constructible<F, F2>::value &&
                     eastl::is_nothrow_constructible<S, S2>::value) //
          : eastl::pair<F, S>{eastl::forward<F2>(that.first), eastl::forward<S2>(that.second)}
        {}
        ...
        common_pair & operator=(eastl::pair<F2, S2> & that) //
        ...
        common_pair & operator=(eastl::pair<F2, S2> const & that) //
        ...
        common_pair const & operator=(eastl::pair<F2, S2> & that) const //
        ...
        common_pair const & operator=(eastl::pair<F2, S2> const & that) const //
    ...
    template(typename F1, typename S1, typename F2, typename S2)(
        requires equality_comparable_with<F1, F2> AND equality_comparable_with<S1, S2>)
    bool operator==(common_pair<F1, S1> const & a, eastl::pair<F2, S2> const & b)
    {
        return a.first == b.first && a.second == b.second;
    }
    template(typename F1, typename S1, typename F2, typename S2)(
        requires equality_comparable_with<F1, F2> AND equality_comparable_with<S1, S2>)
    bool operator==(eastl::pair<F1, S1> const & a, common_pair<F2, S2> const & b)
    {
        return a.first == b.first && a.second == b.second;
    }
    template(typename F1, typename S1, typename F2, typename S2)(
...
#define LOGICAL_OP(OP, CONCEPT, RET)                                               \
    ...
    template(typename F1, typename S1, typename F2, typename S2)(                  \
        requires CONCEPT<F1, F2> AND CONCEPT<S1, S2>)                              \
    bool operator OP(eastl::pair<F1, S1> const & a, common_pair<F2, S2> const & b)   \
    {                                                                              \
        return RET;                                                                \
    }                                                                              \
    template(typename F1, typename S1, typename F2, typename S2)(                  \
        requires CONCEPT<F1, F2> AND CONCEPT<S1, S2>)                              \
    bool operator OP(common_pair<F1, S1> const & a, eastl::pair<F2, S2> const & b)   \
    {                                                                              \
        return RET;                                                                \
    }                                                                              \
    /**/
...
#undef LOGICAL_OP
    ...
    struct make_common_pair_fn
    {
        ...
        common_pair<F, S> operator()(First && f, Second && s) const //
            noexcept(eastl::is_nothrow_constructible<F, unwrap_reference_t<First>>::value &&
