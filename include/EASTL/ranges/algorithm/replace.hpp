...
namespace ranges
{
    ...
    RANGES_FUNC_BEGIN(replace)
        ...
        constexpr I RANGES_FUNC(replace)(I first, S last, T1 const & old_value, T2 const & new_value, P proj = {}) //
        {
        ...
        constexpr borrowed_iterator_t<Rng> RANGES_FUNC(replace)(Rng && rng, T1 const & old_value, T2 const & new_value, P proj = {}) //
        {
