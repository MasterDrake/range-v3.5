...
namespace ranges
{
    ...
    RANGES_FUNC_BEGIN(nth_element)
        ...
        constexpr I RANGES_FUNC(nth_element)(I first, I nth, S end_, C pred = C{}, P proj = P{}) //
        {
        ...
        constexpr borrowed_iterator_t<Rng> RANGES_FUNC(nth_element)(Rng && rng, iterator_t<Rng> nth, C pred = C{}, P proj = P{}) //
        {
