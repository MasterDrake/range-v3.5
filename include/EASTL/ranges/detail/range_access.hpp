...
namespace ranges
{
    ...
    namespace detail
    {
        ...
        template(class T)(requires eastl::is_lvalue_reference<T>::value)
        ...
        template<typename Cur>
        RANGES_INLINE_VAR constexpr bool is_writable_cursor_<Cur, true> = (bool) writable_cursor<Cur, range_access::cursor_value_t<Cur>>;
