...
namespace ranges
{
    ...
    private:
        ...
        public:
            ...
            (
                ...
                // clang-format on
                auto move() const noexcept(noexcept(eastl::declval<cursor const &>().move_(
    ...
    struct zip_with_view : iter_zip_with_view<indirected<Fun>, Rngs...>
    {
        ...
        explicit zip_with_view(Rngs... rngs)
          : iter_zip_with_view<indirected<Fun>, Rngs...>{{Fun{}}, eastl::move(rngs)...}
        {}
    ...
    namespace views
    {
        ...
        struct zip_with_fn
        {
            ...
            {
                return zip_with_view<Fun, all_t<Rngs>...>{ eastl::move(fun), all(static_cast<Rngs &&>(rngs))...};
            }

            template(typename Fun)(requires copy_constructible<Fun> AND invocable<Fun &>) //
                constexpr empty_view<detail::decay_t<invoke_result_t<Fun &>>>
                operator()(Fun) const noexcept
            {
                return {};
