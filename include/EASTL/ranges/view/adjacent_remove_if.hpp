...
namespace ranges
{
    ...
    namespace views
    {
        ...
        {
            template(typename Rng, typename Pred)(requires viewable_range<Rng> AND forward_range<Rng> AND indirect_binary_predicate_<Pred, iterator_t<Rng>, iterator_t<Rng>>)
        ...
        struct adjacent_remove_if_fn : adjacent_remove_if_base_fn
        {
            ...
            {
                return make_view_closure(bind_back(adjacent_remove_if_base_fn{}, eastl::move(pred)));
            }
        };
