...
#include "../utility/optional.hpp" // for non_propagating_cache
...
namespace ranges
{
    ...
    template<typename Rng>
    RANGES_INLINE_VAR constexpr bool enable_borrowed_range<chunk_view<Rng>> = enable_borrowed_range<Rng> && forward_range<Rng>;
