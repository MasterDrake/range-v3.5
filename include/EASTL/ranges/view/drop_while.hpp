...
namespace ranges
{
    ...
    template<typename Rng, typename Pred>
    RANGES_INLINE_VAR constexpr bool enable_borrowed_range<drop_while_view<Rng, Pred>> = enable_borrowed_range<Rng>;
    ...
    namespace views
    {
        ...
        struct RANGES_EMPTY_BASES drop_while_fn : drop_while_base_fn, drop_while_bind_fn
        {
