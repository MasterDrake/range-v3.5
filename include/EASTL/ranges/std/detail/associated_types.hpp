...
namespace ranges
{
    ...
    namespace detail
    {
       ...
       // char (&is_std_iterator_traits_specialized_impl_(std::_Iterator_traits_base<I> *))[2];//TODO: OH NO, serve???????
        ...
        template<typename I>
        RANGES_INLINE_VAR constexpr bool is_std_iterator_traits_specialized_v = 1 == sizeof(is_std_iterator_traits_specialized_impl_<I>(static_cast<eastl::iterator_traits<I> *>(nullptr)));
#endif
