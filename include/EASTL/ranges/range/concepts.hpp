...
#include <string_view>
//TODO:Capire cosa serve traits for string_view 
...
namespace ranges
{
    ...
    template<typename T>
    RANGES_INLINE_VAR constexpr bool enable_view = ext::enable_view<T>::value;

#if defined(__cpp_lib_string_view) && __cpp_lib_string_view >= 201603L
    template<typename Char, typename Traits>
   //TODO:: Oh merda, che fare con sto trait and enable view? RANGES_INLINE_VAR constexpr bool enable_view<std::basic_string_view<Char, Traits>> = true;
   RANGES_INLINE_VAR constexpr bool enable_view<std::basic_string_view<Char, Traits>> = true;
    //RANGES_INLINE_VAR constexpr bool enable_view<eastl::basic_string_view<Char>> = true;
#endif
...
// are also enabled. https://gcc.gnu.org/bugzilla/show_bug.cgi?id=97869
    ...
    RANGES_INLINE_VAR constexpr bool enable_view<eastl::span<T, N>> = true;
#endif
