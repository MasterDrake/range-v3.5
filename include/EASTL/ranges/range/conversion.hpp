...
namespace ranges
{
    ...
    /// \ingroup group-range
    RANGES_INLINE_VARIABLE(detail::to_container_fn<detail::from_range<eastl::vector>>, to_vector)
    ...
    namespace _to_
    {
        ...
        auto to(RANGES_HIDDEN_DETAIL(detail::to_container = {})) -> detail::to_container_fn<meta::id<Cont>>
        {
            return {};
        }
    ...
    template<typename MetaFn, typename Fn>
    RANGES_INLINE_VAR constexpr bool is_pipeable_v<detail::to_container_closure<MetaFn, Fn>> = true;
} // namespace ranges
