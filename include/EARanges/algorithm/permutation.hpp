...
namespace eastl
{
    namespace ranges
    {
        ...
        namespace detail
        {
            ...
            constexpr bool is_permutation_impl(I1 begin1, S1 end1, I2 begin2, S2 end2,
                ...
                requires forward_iterator<I1> AND sentinel_for<S1, I1> AND
                    forward_iterator<I2>
                        AND sentinel_for<S2, I2>
                            AND indirectly_comparable<I1, I2, C, P1, P2>) constexpr bool
            EARANGES_FUNC(is_permutation)(I1 begin1,
                                          S1 end1,
                                          I2 begin2,
                                          S2 end2,
                                          C pred = C{},
            ...
            template(typename Rng1,
                ...
                requires forward_range<Rng1> AND forward_range<Rng2> AND
                    indirectly_comparable<iterator_t<Rng1>,
                                          ...
                                          P1,
                                          P2>) constexpr bool
            EARANGES_FUNC(is_permutation)(Rng1 && rng1,
                                          Rng2 && rng2,
                                          C pred = C{},
                                          P1 proj1 = P1{},
                                          P2 proj2 = P2{}) //
        ...
        EARANGES_FUNC_BEGIN(next_permutation)
            ...
            template(typename I, typename S, typename C = less, typename P = identity)(
                requires bidirectional_iterator<I> AND sentinel_for<S, I> AND
                    sortable<I, C, P>) constexpr bool
            EARANGES_FUNC(next_permutation)(
            ...
            template(typename Rng, typename C = less, typename P = identity)(
                requires bidirectional_range<Rng> AND
                    sortable<iterator_t<Rng>, C, P>) constexpr bool
            EARANGES_FUNC(next_permutation)(Rng && rng, C pred = C{}, P proj = P{}) //
            {
                return (*this)(
        ...
        EARANGES_FUNC_BEGIN(prev_permutation)
            ...
            template(typename I, typename S, typename C = less, typename P = identity)(
                requires bidirectional_iterator<I> AND sentinel_for<S, I> AND
                    sortable<I, C, P>) constexpr bool
            EARANGES_FUNC(prev_permutation)(
                I first, S end_, C pred = C{}, P proj = P{}) //
            {
                if(first == end_)
                    return false;
            ...
            template(typename Rng, typename C = less, typename P = identity)(
                requires bidirectional_range<Rng> AND
                    sortable<iterator_t<Rng>, C, P>) constexpr bool
            EARANGES_FUNC(prev_permutation)(Rng && rng, C pred = C{}, P proj = P{}) //
            {
                return (*this)(
                    begin(rng), end(rng), eastl::move(pred), eastl::move(proj));
            }
