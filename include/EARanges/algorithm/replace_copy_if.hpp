...
namespace ranges
{
    ...
    EARANGES_FUNC_BEGIN(replace_copy_if)
        ...
        constexpr replace_copy_if_result<I, O> EARANGES_FUNC(replace_copy_if)(
        ...
        constexpr replace_copy_if_result<borrowed_iterator_t<Rng>, O> EARANGES_FUNC(replace_copy_if)(
