    ...
    namespace ranges
    {
        ...
        EARANGES_FUNC_BEGIN(equal)
            ...
            template(typename Rng0,
                     ...
                     typename P0 = identity,
                     typename P1 =
                         identity)(requires input_range<Rng0> AND input_range<Rng1> AND
                                       indirectly_comparable<iterator_t<Rng0>,
                                                             iterator_t<Rng1>,
                                                             C,
                                                             P0,
                                                             P1>) constexpr bool
            EARANGES_FUNC(equal)(Rng0 && rng0,
                                 Rng1 && rng1,
                                 C pred = C{},
                                 P0 proj0 = P0{},
                                 P1 proj1 = P1{}) //
