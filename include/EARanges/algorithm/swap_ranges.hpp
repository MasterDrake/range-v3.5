...
namespace ranges
{
    ...
    EARANGES_FUNC_BEGIN(swap_ranges)
        ...
        template(typename I1, typename S1, typename I2)(requires input_iterator<I1> AND sentinel_for<S1, I1> AND input_iterator<I2> AND indirectly_swappable<I1, I2>)
        ...
        /// \overload
        template(typename I1, typename S1, typename I2, typename S2)(requires input_iterator<I1> AND sentinel_for<S1, I1> AND input_iterator<I2> AND sentinel_for<S2, I2> AND indirectly_swappable<I1, I2>)
        constexpr swap_ranges_result<I1, I2> EARANGES_FUNC(swap_ranges)(I1 begin1,
                                                                      S1 end1,
                                                                      I2 begin2,
                                                                      S2 end2) //
        {
        ...
        template(typename Rng1, typename I2_)(requires input_range<Rng1> AND input_iterator<uncvref_t<I2_>> AND indirectly_swappable<iterator_t<Rng1>, uncvref_t<I2_>>)
        ...
        template(typename Rng1, typename Rng2)(requires input_range<Rng1> AND input_range<Rng2> AND indirectly_swappable<iterator_t<Rng1>, iterator_t<Rng2>>)
