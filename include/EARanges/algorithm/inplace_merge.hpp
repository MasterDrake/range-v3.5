    ...
    namespace ranges
    {
        ...
        namespace detail
        {
            ...
            public:
                template(typename I, typename C = less, typename P = identity)(
                    requires bidirectional_iterator<I> AND sortable<I, C, P>) void
                operator()(I first, I middle, I last, iter_difference_t<I> len1,
        ...
        EARANGES_FUNC_BEGIN(inplace_merge)
            ...
            template(typename I, typename S, typename C = less, typename P = identity)(
                requires bidirectional_iterator<I> AND sortable<I, C, P>) I
            EARANGES_FUNC(inplace_merge)(
