...
namespace ranges
{
    ...
    EARANGES_FUNC_BEGIN(find_end)
        ...
        constexpr subrange<I1> EARANGES_FUNC(find_end)(I1 begin1, S1 end1, I2 begin2, S2 end2, R pred = R{}, P proj = P{}) //
        {
        ...
        constexpr borrowed_subrange_t<Rng1> EARANGES_FUNC(find_end)(Rng1 && rng1, Rng2 && rng2, R pred = R{}, P proj = P{}) //
        {
