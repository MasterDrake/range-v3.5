        ...
        EARANGES_FUNC_BEGIN(partition_point)
            ...
            EARANGES_FUNC(partition_point)(I first, S last, C pred, P proj = P{})
            {
                ...
                while(true)
                {
                    ...
                    {
                        len -= d;
                        return aux::partition_point_n(eastl::move(first),
                                                      len,
                                                      ranges::ref(pred),
                                                      ranges::ref(proj));
                    }
            ...
            template(typename Rng, typename C, typename P = identity)(
                requires forward_range<Rng> AND indirect_unary_predicate<
                    C,
            ...
            EARANGES_FUNC(partition_point)(Rng && rng, C pred, P proj = P{})           //
            {
                if(EARANGES_CONSTEXPR_IF(sized_range<Rng>))
                {
                    ...
                    return aux::partition_point_n(
                        begin(rng), len, eastl::move(pred), eastl::move(proj));
                }
                return (*this)(
