...
namespace ranges
{
    ...
    namespace detail
    {
        ...
        template(typename I, typename C, typename P)(requires forward_iterator<I> AND indirect_relation<C, projected<I, P>>)
        ...
        void selection_sort(I first, I last, C & pred, P & proj)
        {
            ...
            {
                I i = ranges::min_element(first, last, eastl::ref(pred), eastl::ref(proj));
                if(i != first)
    ...
    EARANGES_FUNC_BEGIN(nth_element)
        ...
        template(typename I, typename S, typename C = less, typename P = identity)(requires random_access_iterator<I> AND sortable<I, C, P>)
        constexpr I EARANGES_FUNC(nth_element)(I first, I nth, S end_, C pred = C{}, P proj = P{}) //
        {
        ...
        constexpr borrowed_iterator_t<Rng> EARANGES_FUNC(nth_element)(Rng && rng, iterator_t<Rng> nth, C pred = C{}, P proj = P{}) //
        {
            return (*this)(begin(rng), eastl::move(nth), end(rng), eastl::move(pred), eastl::move(proj));
        }
