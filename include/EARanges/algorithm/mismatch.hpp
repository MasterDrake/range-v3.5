    ...
    namespace ranges
    {
        ...
        EARANGES_FUNC_BEGIN(mismatch)
                    ...
                    input_iterator<I2>
                        AND sentinel_for<S2, I2>
                            AND indirect_relation<
                                C,
                                projected<I1, P1>,
                                projected<I2, P2>>) constexpr mismatch_result<I1, I2>
            EARANGES_FUNC(mismatch)(I1 begin1,
                                    S1 end1,
                                    I2 begin2,
                                    S2 end2,
                                    C pred = C{},
            ...
            template(typename Rng1,
                     ...
                     typename P1 = identity,
                     typename P2 = identity)(
                requires input_range<Rng1> AND input_range<Rng2> AND indirect_relation<
                    C,
                    projected<iterator_t<Rng1>, P1>,
                    projected<iterator_t<Rng2>,
                              P2>>) constexpr mismatch_result<borrowed_iterator_t<Rng1>,
                                                              borrowed_iterator_t<
                                                                  Rng2>> //
        ...
        // [*] In this case, the 'begin2' iterator is taken by universal reference. Why?
        // So that we can properly distinguish this case:
        //   int x[] = {1,2,3,4};
        //   int y[] = {1,2,3,4};
        //   mismatch(x, y);
        // Had 'begin2' been taken by value as is customary, this call could match as
        // either two ranges, or a range and an iterator, where the iterator is the array,
        // decayed to a pointer. Yuk!
