    ...
    namespace ranges
    {
        ...
        EARANGES_FUNC_BEGIN(contains_subrange)
            ...
            template(typename I1,
                ...
                /// \pre
                requires forward_iterator<I1>
                    AND sentinel_for<S1, I1>
                        AND forward_iterator<I2>
            ...
            EARANGES_FUNC(contains)(I1 first1,
                                    S1 last1,
                                    I2 first2,
                                    S2 last2,
                                    Pred pred = {},
            ...
            template(typename Rng1,
                ...
                requires forward_range<Rng1>
                    AND forward_range<Rng2>
                        AND indirectly_comparable<iterator_t<Rng1>,
                                                  iterator_t<Rng2>,
                                                  Pred,
                                                  Proj1,
                                                  Proj2>) constexpr bool
            EARANGES_FUNC(contains)(Rng1 && rng1,
                                    Rng2 && rng2,
                                    Pred pred = {},
                                    Proj1 proj1 = {},
                                    Proj2 proj2 = {})
            {
                return (*this)(ranges::begin(rng1),
                               ranges::end(rng1),
                               ranges::begin(rng2),
                               ranges::end(rng2),
                               eastl::move(pred),
