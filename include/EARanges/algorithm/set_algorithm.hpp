    ...
    namespace ranges
    {
                ...
                requires input_iterator<I1> AND sentinel_for<S1, I1> AND input_iterator<
                    ...
                    AND sentinel_for<S2, I2>
                        AND indirect_strict_weak_order<C,
                                                       projected<I1, P1>,
                                                       projected<I2, P2>>) constexpr bool
            EARANGES_FUNC(includes)(I1 begin1,
                                    S1 end1,
                                    I2 begin2,
                                    S2 end2,
                                    C pred = C{},
            ...
            template(typename Rng1,
                ...
                requires input_range<Rng1> AND input_range<Rng2> AND
                    indirect_strict_weak_order<
                        ...
                        projected<iterator_t<Rng2>, P2>>) constexpr bool
            EARANGES_FUNC(includes)(Rng1 && rng1,
                                    Rng2 && rng2,
                                    C pred = C{},
                                    P1 proj1 = P1{},
                                    P2 proj2 = P2{}) //
        ...
        EARANGES_FUNC_BEGIN(set_union)
            ...
            template(typename I1,
                ...
                requires sentinel_for<S1, I1> AND sentinel_for<S2, I2> AND
                    mergeable<I1, I2, O, C, P1, P2>) constexpr set_union_result<I1, I2, O>
            EARANGES_FUNC(set_union)(I1 begin1,
                                     S1 end1,
                                     I2 begin2,
                                     S2 end2,
                                     O out,
            ...
            template(typename Rng1,
                ...
                requires range<Rng1> AND range<Rng2> AND
                    mergeable<iterator_t<Rng1>,
                              ...
                              C,
                              P1,
                              P2>) constexpr set_union_result<borrowed_iterator_t<Rng1>,
        ...
        EARANGES_FUNC_BEGIN(set_intersection)
            ...
            template(typename I1,
                     ...
                     typename P2 = identity)(
                requires sentinel_for<S1, I1> AND sentinel_for<S2, I2> AND
                    mergeable<I1, I2, O, C, P1, P2>) constexpr O
            EARANGES_FUNC(set_intersection)(I1 begin1,
                                            S1 end1,
                                            I2 begin2,
                                            S2 end2,
                                            O out,
            ...
            template(typename Rng1,
                     ...
                     typename P1 = identity,
                     typename P2 = identity)(
                requires range<Rng1> AND range<Rng2> AND mergeable<iterator_t<Rng1>,
                                                                   iterator_t<Rng2>,
                                                                   O,
                                                                   C,
                                                                   P1,
                                                                   P2>) constexpr O
            EARANGES_FUNC(set_intersection)(Rng1 && rng1,
                                            Rng2 && rng2,
                                            O out,
                                            C pred = C{},
                                            P1 proj1 = P1{},
        ...
        EARANGES_FUNC_BEGIN(set_difference)
            ...
            template(typename I1,
                     ...
                     typename P2 = identity)(
                requires sentinel_for<S1, I1> AND sentinel_for<S2, I2> AND
                    mergeable<I1, I2, O, C, P1, P2>) constexpr set_difference_result<I1,
                                                                                     O>
            EARANGES_FUNC(set_difference)(I1 begin1,
                                          S1 end1,
                                          I2 begin2,
                                          S2 end2,
                                          O out,
            ...
            template(typename Rng1,
                     ...
                     typename P1 = identity,
                     typename P2 = identity)(
                requires range<Rng1> AND range<Rng2> AND mergeable<
                    iterator_t<Rng1>,
                    iterator_t<Rng2>,
                    O,
                    C,
                    P1,
                    P2>) constexpr set_difference_result<borrowed_iterator_t<Rng1>, O> //
        ...
        EARANGES_FUNC_BEGIN(set_symmetric_difference)
            ...
            template(typename I1,
                ...
                requires sentinel_for<S1, I1> AND sentinel_for<S2, I2> AND
                    mergeable<I1,
                              ...
                              C,
                              P1,
                              P2>) constexpr set_symmetric_difference_result<I1, I2, O> //
            ...
            template(typename Rng1,
                ...
                requires range<Rng1> AND range<Rng2> AND mergeable<
                    ...
                    C,
                    P1,
                    P2>) constexpr set_symmetric_difference_result<borrowed_iterator_t<Rng1>,
                                                                   borrowed_iterator_t<
                                                                       Rng2>,
                                                                   O>
