...
namespace ranges
{
    ...
    EARANGES_FUNC_BEGIN(none_of)
        ...
        constexpr bool EARANGES_FUNC(none_of)(I first, S last, F pred, P proj = P{}) //
        {
            return eastl::none_of(first, last, eastl::move(pred), eastl::move(proj));
        }
        ...
        constexpr bool EARANGES_FUNC(none_of)(Rng && rng, F pred, P proj = P{}) //
        {
