...
namespace ranges
{
                                                 ...
                                                 P2 & proj2)
        {
            ...
            while(true)
            {
                ...
                while(true)
                {
                    ...
                    {
                        auto e =
                            ranges::next(recounted(begin1_, eastl::move(begin1), d1_ - d1), eastl::move(end1));
                        return {e, e};
                    }
                ...
                while(true)
                {
                    ...
                    {
                        return {recounted(begin1_, eastl::move(begin1), d1_ - d1), recounted(begin1_, eastl::move(++m1), d1_ - d1)};
                    }
    ...
    EARANGES_FUNC_BEGIN(search)
        ...
        constexpr subrange<I1> EARANGES_FUNC(search)(I1 begin1,
                                                   S1 end1,
                                                   I2 begin2,
                                                   S2 end2,
                                                   C pred = C{},
        ...
        template(typename Rng1,
                 ...
                 typename P1 = identity,
                 typename P2 = identity)(
            requires forward_range<Rng1> AND forward_range<Rng2> AND indirectly_comparable<iterator_t<Rng1>, iterator_t<Rng2>, C, P1, P2>)
        constexpr borrowed_subrange_t<Rng1> EARANGES_FUNC(search)(Rng1 && rng1, Rng2 && rng2, C pred = C{}, P1 proj1 = P1{}, P2 proj2 = P2{}) //
        {
            if(empty(rng2))
