        ...
        struct partial_sum_fn
        {
            template(typename I, typename S1, typename O, typename S2,
                ...
                requires sentinel_for<S1, I> AND sentinel_for<S2, O> AND
                    partial_sum_constraints<I, O, BOp, P>) partial_sum_result<I, O>
            operator()(I first, S1 last, O result, S2 end_result, BOp bop = BOp{},
                       P proj = P{}) const
            {
            ...
            template(typename Rng, typename ORng, typename BOp = plus,
                ...
                requires range<Rng> AND range<ORng> AND
