...
{
    template<typename T>
    using remove_cvref_t = typename eastl::remove_cv<typename eastl::remove_reference<T>::type>::type;

    /// \cond
    namespace detail
    {
        template<typename From, typename To>
        using is_convertible = eastl::is_convertible<meta::_t<eastl::add_rvalue_reference<From>>, To>;
        ...
        using _rref_res =
            if_else_t<eastl::is_reference<R>::value, meta::_t<eastl::remove_reference<R>> &&, R>;
    ...
    {
        using _rref =
            meta::quote_trait<eastl::add_rvalue_reference>;
        using _lref =
            meta::quote_trait<eastl::add_lvalue_reference>;
        ...
        template<typename T, typename U>
        struct _common_reference2<T, U, if_t<eastl::is_reference<_builtin_common_t<T, U>>::value>>
            : _builtin_common<T, U>
        {};
    }
    /// \endcond
