...
namespace eastl
{
    namespace concepts
    {
        ...
        using remove_cvref_t =
            typename eastl::remove_cv<typename eastl::remove_reference<T>::type>::type;
        ...
        namespace detail
        {
            ...
            template<typename T, typename U>
            using _cond_res = decltype(true ? eastl::declval<T>() : eastl::declval<U>());

            template<typename T, typename U, typename R = _builtin_common_t<T &, U &>>
            using _rref_res = if_else_t<eastl::is_reference<R>::value,
                                        meta::_t<eastl::remove_reference<R>> &&, R>;
            ...
            {};
            template<typename T, typename U>
            struct _builtin_common_3<T, U,
                                     meta::void_<_cond_res<as_cref_t<T>, as_cref_t<U>>>>
              : eastl::decay<_cond_res<as_cref_t<T>, as_cref_t<U>>>
            {};
            template<typename T, typename U, typename = void>
            struct _builtin_common_2 : _builtin_common_3<T, U>
            {};
            template<typename T, typename U>
            struct _builtin_common_2<T, U, meta::void_<_cond_res<T, U>>>
              : eastl::decay<_cond_res<T, U>>
            {};
            template<typename T, typename U, typename /* = void */>
            struct _builtin_common : _builtin_common_2<T, U>
            {};
            template<typename T, typename U>
            struct _builtin_common<T &&, U &&,
                                   if_t<is_convertible<T &&, _rref_res<T, U>>::value &&
            ...
            struct _builtin_common<
                T &, U &&,
                if_t<is_convertible<U &&, _builtin_common_t<T &, U const &>>::value>>
            ...
            {};
            template<typename T, typename U, typename = void>
            struct _builtin_common_rr : _builtin_common_2<T &&, U &&>
            {};
            template<typename T, typename U>
            struct _builtin_common_rr<T, U,
                                      if_t<is_convertible<T &&, _rref_res<T, U>>::value &&
                                           is_convertible<U &&, _rref_res<T, U>>::value>>
            {
                using type = _rref_res<T, U>;
            ...
            template<typename T, typename U>
            struct _builtin_common<T &&, U &&> : _builtin_common_rr<T, U>
            {};
            template<typename T, typename U>
            struct _builtin_common<T &, U &> : meta::defer<_lref_res, T, U>
            {};
            template<typename T, typename U, typename = void>
            struct _builtin_common_lr : _builtin_common_2<T &, T &&>
            {};
            template<typename T, typename U>
            ...
            {};
            template<typename T, typename U>
            struct _builtin_common<T &, U &&> : _builtin_common_lr<T, U>
            {};
            template<typename T, typename U>
            struct _builtin_common<T &&, U &> : _builtin_common<U &, T &&>
            {};
        ...
        template<typename T>
        struct common_type<T> : eastl::decay<T>
        {};

        template<typename T, typename U>
        struct common_type<T, U>
          : detail::if_else_t<(META_IS_SAME(detail::decay_t<T>, T) &&
        ...
        namespace detail
        {
            using _rref = meta::quote_trait<eastl::add_rvalue_reference>;
            using _lref = meta::quote_trait<eastl::add_lvalue_reference>;
            ...
            struct _xref<T &&>
            {
                template<typename U>
                using invoke =
                    meta::_t<eastl::add_rvalue_reference<meta::invoke<_xref<T>, U>>>;
            };
            template<typename T>
            struct _xref<T &>
            {
                template<typename U>
                using invoke =
                    meta::_t<eastl::add_lvalue_reference<meta::invoke<_xref<T>, U>>>;
            };
            template<typename T>
            ...
            struct _common_reference2
              : if_else_t<meta::is_trait<_basic_common_reference<T, U>>::value,
                          _basic_common_reference<T, U>, common_type<T, U>>
            {};

            template<typename T, typename U>
            struct _common_reference2<
                T, U, if_t<eastl::is_reference<_builtin_common_t<T, U>>::value>>
              : _builtin_common<T, U>
            {};
        } // namespace detail
        /// \endcond
