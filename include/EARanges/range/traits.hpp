...
namespace eastl
{
    namespace ranges
    {
        ...
        using common_iterator_t =
            meta::conditional_t<eastl::is_same<I, S>::value, I,
        ...
        namespace detail
        {
            ...
            eastl::integral_constant<cardinality, Card> test_cardinality(
                basic_view<Card> *);
            template<typename T, std::size_t N>
            eastl::integral_constant<cardinality, static_cast<cardinality>(N)>
                test_cardinality(T (*)[N]);
            template<typename T, std::size_t N>
            eastl::integral_constant<cardinality, static_cast<cardinality>(N)>
            test_cardinality(eastl::array<T, N> *);
        } // namespace detail
        /// \endcond
