...
#ifndef EARANGES_RANGE_FWD_HPP
#define EARANGES_RANGE_FWD_HPP
...
// it ignores the deprecation attribute. Frustrating.
        ...
        namespace detail
        {
            ...
            template<typename T>
            constexpr meta::_t<eastl::remove_reference<T>> && move(T && t) noexcept
            {
            ...
            EARANGES_INLINE_VARIABLE(as_const_fn, as_const)

            template<typename T>
            using as_const_t = decltype(as_const(eastl::declval<T>()));

            template<typename T>
            using decay_t = meta::_t<eastl::decay<T>>;

            template<typename T, typename R = meta::_t<eastl::remove_reference<T>>>
            using as_ref_t =
                meta::_t<eastl::add_lvalue_reference<meta::_t<eastl::remove_const<R>>>>;

            template<typename T, typename R = meta::_t<eastl::remove_reference<T>>>
            using as_cref_t = meta::_t<eastl::add_lvalue_reference<R const>>;
            ...
            EARANGES_INLINE_VAR constexpr bool is_trivially_constructible_v =
                __is_trivially_constructible(T, Args...);
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_trivially_default_constructible_v =
                is_trivially_constructible_v<T>;
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_trivially_copy_constructible_v =
                is_trivially_constructible_v<T, T const &>;
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_trivially_move_constructible_v =
                is_trivially_constructible_v<T, T>;
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_trivially_copyable_v =
                __is_trivially_copyable(T);
            template<typename T, typename U>
            EARANGES_INLINE_VAR constexpr bool is_trivially_assignable_v =
                __is_trivially_assignable(T, U);
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_trivially_copy_assignable_v =
                is_trivially_assignable_v<T &, T const &>;
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_trivially_move_assignable_v =
            ...
            {};
            template<typename T>
            struct is_trivially_copyable : meta::bool_<is_trivially_copyable_v<T>>
            {};
            template<typename T, typename U>
            struct is_trivially_assignable : meta::bool_<is_trivially_assignable_v<T, U>>
            {};
            template<typename T>
            ...
            {};
#else // TODO:Mannaggia da controllare se esistono e se va bene usare le _v versions :O
            ...
            using eastl::is_trivially_assignable_v;
            using eastl::is_trivially_constructible_v;
            using eastl::is_trivially_copy_assignable_v;
            using eastl::is_trivially_copy_constructible_v;
            using eastl::is_trivially_copyable_v;
            using eastl::is_trivially_default_constructible_v;
            using eastl::is_trivially_move_assignable_v;
            using eastl::is_trivially_move_constructible_v;
#else
            template<typename T, typename... Args>
            EARANGES_INLINE_VAR constexpr bool is_trivially_constructible_v =
            ...
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_trivial_v =
                is_trivially_copyable_v<T> && is_trivially_default_constructible_v<T>;

            template<typename T>
            struct is_trivial : meta::bool_<is_trivial_v<T>>
            {};

#if EARANGES_CXX_LIB_IS_FINAL > 0
#if defined(__clang__) && !defined(_LIBCPP_VERSION)
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_final_v = __is_final(T);

            template<typename T>
            struct is_final : meta::bool_<is_final_v<T>>
            {};
#else
            using eastl::is_final;
#if META_CXX_TRAIT_VARIABLE_TEMPLATES
            using eastl::is_final_v;
#else
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_final_v = is_final<T>::value;
#endif
#endif
#else
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_final_v = false;

            template<typename T>
            using is_final = eastl::false_type;
#endif
            ...
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_function_v =
            ...
            using is_convertible =
                eastl::is_convertible<meta::_t<eastl::add_rvalue_reference<From>>, To>;
        } // namespace detail
        /// \endcond
        ...
        template<typename T>
        using uncvref_t =
            meta::_t<eastl::remove_cv<meta::_t<eastl::remove_reference<T>>>>;
    ...
    defined(__cpp_concepts) && defined(__cpp_impl_three_way_comparison)
        ...
        EARANGES_INLINE_VAR constexpr bool disable_sized_sentinel = false;
        ...
        template<typename Cur>
        struct EARANGES_EMPTY_BASES basic_iterator;
        ...
        struct EARANGES_EMPTY_BASES iterator_range;
