...
#pragma GCC diagnostic ignored \
    "-Wreserved-identifier" // _z at namespace scope is not reserved
#endif
...
namespace meta
{
    ...
    /// \ingroup integral
    template<bool B>
    using bool_ = eastl::integral_constant<bool, B>;

    /// An integral constant wrapper for \c int.
    /// \ingroup integral
    template<int Int>
    using int_ = eastl::integral_constant<int, Int>;

    /// An integral constant wrapper for \c char.
    /// \ingroup integral
    template<char Ch>
    using char_ = eastl::integral_constant<char, Ch>;

    ///////////////////////////////////////////////////////////////////////////////////////////
    // Math operations
    /// An integral constant wrapper around the result of incrementing the wrapped integer
    /// \c T::type::value.
    template<META_TYPE_CONSTRAINT(integral) T>
    using inc = eastl::integral_constant<decltype(T::type::value + 1), T::type::value + 1>;

    /// An integral constant wrapper around the result of decrementing the wrapped integer
    /// \c T::type::value.
    template<META_TYPE_CONSTRAINT(integral) T>
    using dec = eastl::integral_constant<decltype(T::type::value - 1), T::type::value - 1>;
    ...
    using plus = eastl::integral_constant<decltype(T::type::value + U::type::value),
                                        T::type::value + U::type::value>;

    /// An integral constant wrapper around the result of subtracting the two wrapped
    /// integers \c T::type::value and \c U::type::value. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using minus = eastl::integral_constant<decltype(T::type::value - U::type::value),
                                         T::type::value - U::type::value>;

    /// An integral constant wrapper around the result of multiplying the two wrapped
    /// integers \c T::type::value and \c U::type::value. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using multiplies = eastl::integral_constant<decltype(T::type::value * U::type::value),
                                              T::type::value * U::type::value>;

    /// An integral constant wrapper around the result of dividing the two wrapped
    /// integers \c T::type::value and \c U::type::value. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using divides = eastl::integral_constant<decltype(T::type::value / U::type::value),
                                           T::type::value / U::type::value>;
    ...
    /// \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T>
    using negate = eastl::integral_constant<decltype(-T::type::value), -T::type::value>;

    /// An integral constant wrapper around the remainder of dividing the two wrapped
    /// integers \c T::type::value and \c U::type::value. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using modulus = eastl::integral_constant<decltype(T::type::value % U::type::value),
                                           T::type::value % U::type::value>;

    /// A Boolean integral constant wrapper around the result of comparing \c
    /// T::type::value and \c U::type::value for equality. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using equal_to = bool_<T::type::value == U::type::value>;

    /// A Boolean integral constant wrapper around the result of comparing \c
    /// T::type::value and \c U::type::value for inequality. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using not_equal_to = bool_<T::type::value != U::type::value>;

    /// A Boolean integral constant wrapper around \c true if \c T::type::value is greater
    /// than \c U::type::value; \c false, otherwise. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using greater = bool_<(T::type::value > U::type::value)>;

    /// A Boolean integral constant wrapper around \c true if \c T::type::value is less
    /// than \c U::type::value; \c false, otherwise. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using less = bool_<(T::type::value < U::type::value)>;

    /// A Boolean integral constant wrapper around \c true if \c T::type::value is greater
    /// than or equal to \c U::type::value; \c false, otherwise. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    ...
    /// \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using bit_and = eastl::integral_constant<decltype(T::type::value & U::type::value),
                                           T::type::value & U::type::value>;
    ...
    /// \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using bit_or = eastl::integral_constant<decltype(T::type::value | U::type::value),
                                          T::type::value | U::type::value>;
    ...
    /// \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T, META_TYPE_CONSTRAINT(integral) U>
    using bit_xor = eastl::integral_constant<decltype(T::type::value ^ U::type::value),
                                           T::type::value ^ U::type::value>;

    /// An integral constant wrapper around the result of bitwise-complementing the
    /// wrapped integer \c T::type::value. \ingroup math
    template<META_TYPE_CONSTRAINT(integral) T>
    using bit_not = eastl::integral_constant<decltype(~T::type::value), ~T::type::value>;
    ...
    using integer_range = _t<detail::coerce_indices_<
        T, From, make_index_sequence<detail::range_distance_(From, To)>>>;
    ...
    namespace detail
    {
        ...
        template<typename T>
        META_INLINE_VAR constexpr bool is_callable_<T, void_<quote<T::template invoke>>> =
            true;
    } // namespace detail
    /// \endcond
    ...
    namespace detail
    {
        ...
        struct is_trait_
        {
            using type = eastl::false_type;
        };

        template<typename T>
        struct is_trait_<T, void_<typename T::type>>
        {
            using type = eastl::true_type;
        };
    ...
    /// An alias for `eastl::true_type` if `T::invoke` exists and names a class
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    // defer
    /// A wrapper that defers the instantiation of a template \p C with type parameters \p
    /// Ts in a \c lambda or \c let expression.
    ///
    /// In the code below, the lambda would ideally be written as
    /// `lambda<_a,_b,push_back<_a,_b>>`, however this fails since `push_back` expects its
    /// first argument to be a list, not a placeholder. Instead, we express it using \c
    /// defer as follows:
    ///
    /// \code
    /// template <typename L>
    ...
    /// in a \c lambda or \c let expression. \sa `defer` \ingroup invocation
    template<template<typename...> class C, typename... Ts>
    ...
    namespace detail
    {
        ...
        struct is_ : eastl::false_type
        {};

        template<typename... Ts, template<typename...> class C>
        struct is_<C<Ts...>, C> : eastl::true_type
        {};
    } // namespace detail
    /// \endcond
    ...
    /// \code
    /// static_assert(eastl::is_same_v<invoke<quote_trait<eastl::add_const>, int>, int const>, "");
    /// \endcode
    /// \ingroup composition
    template <template <typename...> class C>
    ...
    namespace extension
    {
        ...
        struct apply<Fn, integer_sequence<T, Is...>>
          : lazy::invoke<Fn, eastl::integral_constant<T, Is>...>
        {};
    } // namespace extension
    ...
    namespace detail
    {
        ...
        struct _if_<If> : eastl::enable_if<_v<If>>
        {};

        template<typename If, typename Then>
            requires integral<If>
        struct _if_<If, Then> : eastl::enable_if<_v<If>, Then>
        {};

        template<typename If, typename Then, typename Else>
            requires integral<If>
        struct _if_<If, Then, Else> : eastl::conditional<_v<If>, Then, Else>
        {};
    ...
    namespace detail
    {
        ...
        template<typename B, typename... Bs>
            requires integral<B> && (!bool(B::type::value))
        struct _and_<B, Bs...> : eastl::false_type
        {};
        ...
        template<>
        struct _or_<> : eastl::false_type
        {};

        template<typename B, typename... Bs>
            requires integral<B> && (bool(B::type::value))
        struct _or_<B, Bs...> : eastl::true_type
        {};
        ...
        struct _and_<false>
        {
            template<typename B, typename... Bs>
            using invoke = invoke<
                if_c<!B::type::value, id<eastl::false_type>, _and_<0 == sizeof...(Bs)>>,
                Bs...>;
        };
        ...
        struct _or_<false>
        {
            template<typename B, typename... Bs>
            using invoke =
                invoke<if_c<B::type::value, id<eastl::true_type>, _or_<0 == sizeof...(Bs)>>,
                       Bs...>;
        };
#endif
    } // namespace detail
    ...
    template<bool... Bs>
    using and_c = meta::bool_<META_IS_SAME(integer_sequence<bool, true, Bs...>,
                                           integer_sequence<bool, Bs..., true>)>;
#else
    template<bool... Bs>
    struct and_c
      : meta::bool_<META_IS_SAME(integer_sequence<bool, Bs...>,
                                 integer_sequence<bool, (Bs || true)...>)>
    {};
#endif
#if META_CXX_VARIABLE_TEMPLATES
    template<bool... Bs>
    META_INLINE_VAR constexpr bool and_v = META_IS_SAME(
        integer_sequence<bool, Bs...>, integer_sequence<bool, (Bs || true)...>);
#endif
#endif
...
#if META_CXX_VARIABLE_TEMPLATES
    template<bool... Bs>
    META_INLINE_VAR constexpr bool or_v = !META_IS_SAME(
        integer_sequence<bool, Bs...>, integer_sequence<bool, (Bs && false)...>);
#endif
#endif
    ...
    namespace detail
    {
        ...
        template<typename Fn, typename T0, typename T1, typename T2, typename T3,
        ...
        struct compose10_
        {
            ...
            template<typename S>
            using invoke =
                F<F<F<F<F<F<F<F<F<F<_t<S>, T0>, T1>, T2>, T3>, T4>, T5>, T6>, T7>, T8>,
                  T9>;
        };
        ...
        struct compose_
        {
            ...
            template<typename T0, typename T1, typename T2, typename T3, typename T4,
                     ...
                     typename State>
            using invoke =
                F<F<F<F<F<F<F<F<F<F<State, T0>, T1>, T2>, T3>, T4>, T5>, T6>, T7>, T8>,
                  T9>;
        };
        ...
        template<typename T0, typename T1, typename T2, typename T3, typename T4,
                 typename T5, typename T6, typename T7, typename T8, typename T9,
                 typename... Tail, typename State, typename Fn>
            requires valid<invoke, compose_<Fn>, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9,
                           State>
        ...
        struct fold_<list<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, Tail...>, State, Fn>
          : fold_<list<Tail...>,
                  lazy::invoke<compose10_<Fn, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>,
                               State>,
                  Fn>
        {};
#endif // META_CONCEPT
    ...
    /// `O(N)`.
    /// \ingroup transformation
    template<META_TYPE_CONSTRAINT(list_like) L, typename State,
             META_TYPE_CONSTRAINT(invocable) Fn>
#ifdef META_CONCEPT
    ...
    namespace detail
    {
        ...
        template<typename T0, typename T1, typename T2, typename T3, typename T4,
                 typename T5, typename T6, typename T7, typename T8, typename T9,
                 typename... Tail, typename State, typename Fn>
        struct reverse_fold_<list<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, Tail...>, State,
                             Fn>
    ...
    /// Return a new \c meta::list constructed by doing a right fold of the list \p L
    /// using binary invocable \p Fn and initial state \p State. That is, the \c State(N)
    /// for the list element \c A(N) is computed by `Fn(A(N), State(N+1)) -> State(N)`.
    /// \par Complexity
    /// `O(N)`.
    /// \ingroup transformation
    template<META_TYPE_CONSTRAINT(list_like) L, typename State,
    ...
    namespace detail
    {
        ...
        struct concat_<list<L1...>, list<L2...>, list<L3...>, list<L4...>, list<L5...>,
                       ...
                       Rest...>
          : concat_<list<L1..., L2..., L3..., L4..., L5..., L6..., L7..., L8..., L9...,
                         L10...>,
                    Rest...>
        {};
    } // namespace detail
...
#endif
            using type =
                size_t<reverse_find_index_i_(s_v, s_v + sizeof...(T), sizeof...(T))>;
        };
    } // namespace detail
    /// \endcond
    ...
    /// Return the tail of the list \p L starting at the last occurrence of \p T, if any
    /// such element exists; the empty list, otherwise. \par Complexity `O(N)`. \ingroup
    /// query
    template<META_TYPE_CONSTRAINT(list_like) L, typename T>
...
#endif
            using type = drop_c<list<L...>, detail::find_if_i_(s_v, s_v + sizeof...(L)) - s_v>;
        };
#endif
    } // namespace detail
    /// \endcond
    ...
    namespace detail
    {
        ...
        struct reverse_find_if_<list<Head, L...>, Fn, State>
          : reverse_find_if_<list<L...>, Fn,
                             if_<invoke<Fn, Head>, list<Head, L...>, State>>
        {};
#else
        constexpr bool const * reverse_find_if_i_(bool const * const begin,
                                                  bool const * const pos,
                                                  bool const * const end)
        {
            return begin == pos ? end
                   : *(pos - 1) ? pos - 1
                                : reverse_find_if_i_(begin, pos - 1, end);
        }
        ...
        struct reverse_find_if_< list<L...>, Fn, void_<integer_sequence<bool, bool(invoke<Fn, L>::type::value)...>>>
        {
            ...
            static constexpr bool s_v[] = {invoke<Fn, L>::type::value...};
#endif
            using type =  drop_c<list<L...>, detail::reverse_find_if_i_(s_v, s_v + sizeof...(L), s_v + sizeof...(L)) - s_v>;
        };
#endif
    } // namespace detail
    /// \endcond
    ...
    /// elements in the list \p L. \par Complexity `O(N)`. \ingroup query
    template<META_TYPE_CONSTRAINT(list_like) L, META_TYPE_CONSTRAINT(invocable) Fn>
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    // transpose
    /// Given a list of lists of types \p ListOfLists, transpose the elements from the
    /// lists. \par Complexity `O(N * M)`, where `N` is the size of the outer list, and
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    // zip_with
    /// Given a list of lists of types \p ListOfLists and an invocable \p Fn, construct a
    /// new list by calling \p Fn with the elements from the lists pairwise. \par
    /// Complexity `O(N * M)`, where `N` is the size of the outer list, and `M` is the
    /// size of the inner lists. \ingroup transformation
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    // zip
    /// Given a list of lists of types \p ListOfLists, construct a new list by grouping
    /// the elements from the lists pairwise into `meta::list`s. \par Complexity `O(N *
    /// M)`, where `N` is the size of the outer list, and `M` is the size of the inner
    /// lists. \ingroup transformation
    template<META_TYPE_CONSTRAINT(list_like) ListOfLists>
    ...
    {
        template<typename T>
        using uncvref_t = _t<eastl::remove_cv<_t<eastl::remove_reference<T>>>>;
    ...
    /// \c true for all elements \c A in \c meta::list \p L; \c false, otherwise. \par
    /// Complexity `O(N)`. \ingroup query
    template<META_TYPE_CONSTRAINT(list_like) L, META_TYPE_CONSTRAINT(invocable) Fn>
    ...
    /// occurrence of \p T in \p L. \par Complexity `O(N)`. \ingroup query
    template<META_TYPE_CONSTRAINT(list_like) L, typename T>
    ...
    namespace detail
    {
        template<META_TYPE_CONSTRAINT(invocable) Fn, typename A, typename B,
                 typename... Ts>
...
#endif
        {
            ...
            using type =
                concat<_t<sort_<first<P>, Fn>>, list<A>, _t<sort_<second<P>, Fn>>>;
        };
    } // namespace detail
    /// \endcond
    ...
    namespace detail
    {
        ...
        using substitutions =
            ...
            invoke<if_c<(size<Ts>::value + 2 >= size<As>::value), quote<substitutions_>>,
                   As, Ts>;
#else  // ^^^ workaround ^^^ / vvv no workaround vvv
        ...
        template<typename T>
        struct is_vararg_ : eastl::false_type
        {};
        template<typename T>
        struct is_vararg_<vararg_<T>> : eastl::true_type
        {};
        ...
        private:
            ...
            struct impl<defer<and_, B, Bs...>, Args> // Short-circuit and_
              : impl<lazy_impl_<lazy_if_<B, lazy::and_<Bs...>, protect_<eastl::false_type>>,
                                Args>,
                     Args>
            {};
            template<typename B, typename... Bs, typename Args>
            struct impl<defer<or_, B, Bs...>, Args> // Short-circuit or_
              : impl<lazy_impl_<lazy_if_<B, protect_<eastl::true_type>, lazy::or_<Bs...>>,
                                Args>,
                     Args>
            {};
            template<template<typename...> class C, typename... Ts, typename Args>
    ...
    /// \code
    /// using L = lambda<_a, _b, eastl::pair<_b, eastl::pair<_a, _a>>>;
    /// using P = invoke<L, int, short>;
    /// static_assert(eastl::is_same_v<P, eastl::pair<short, eastl::pair<int, int>>>, "");
    /// \endcode
    /// \ingroup trait
    template<typename... Ts>
#ifdef META_CONCEPT
    ...
    /// Cartesian Product. Like the `sequence` function from the Haskell Prelude. \par
    /// Complexity `O(N * M)`, where `N` is the size of the outer list, and `M` is the
    /// size of the inner lists. \ingroup transformation
    template<META_TYPE_CONSTRAINT(list_like) ListOfLists>
    ...
    namespace detail
    {
        ...
        using atoi_ = if_c<(Ch::value >= '0' && Ch::value <= '9'),
                           eastl::integral_constant<typename State::value_type,
