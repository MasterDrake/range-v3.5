...
namespace eastl
{
    namespace ranges
    {
        ...
        namespace adl_insert_detail
        {
            ...
            using insert_result_t = decltype(unwrap_reference(eastl::declval<Cont>())
                                                 .insert(eastl::declval<Args>()...));

            template(typename Cont, typename T)(requires lvalue_container_like<Cont> AND(
            ...
            template(typename Cont, typename I, typename S)(
                requires lvalue_container_like<Cont> AND sentinel_for<S, I> AND(
                    !range<S>))
                insert_result_t<Cont &, detail::cpp17_iterator_t<I, S>,
                                detail::cpp17_iterator_t<I, S>> insert(Cont && cont, I i,
                                                                       S j)
            {
            ...
            template(typename Cont,
                ...
                insert_result_t<Cont &, detail::range_cpp17_iterator_t<Rng>,
                                detail::range_cpp17_iterator_t<Rng>> insert(Cont && cont,
                                                                            Rng && rng)
            {
            ...
            template(typename Cont, typename I, typename N, typename T)(
                requires lvalue_container_like<Cont> AND input_iterator<I> AND integral<N>
            ...
            namespace detail
            {
                ...
                template(typename Cont,
                         typename P)(requires container<Cont> AND input_iterator<P> AND
                                         random_access_reservable<Cont>)
                    iterator_t<Cont> insert_reserve_helper(Cont & cont, P const p,
                ...
                template(typename Cont, typename P, typename I,
                         typename S)(requires sentinel_for<S, I> AND(!range<S>)) //
                ...
                template(typename Cont, typename P, typename I, typename S)(
                    requires sized_sentinel_for<S, I> AND random_access_reservable<Cont>
                        AND(!range<S>)) //
                    auto insert_impl(Cont && cont_, P p, I i, S j, eastl::true_type)
                        -> decltype(unwrap_reference(cont_).insert(
                            ...
                            cpp17_iterator_t<I, S>{i}, cpp17_iterator_t<I, S>{j}))
                {
                    using C = cpp17_iterator_t<I, S>;
                ...
                template(typename Cont, typename I, typename Rng)(
                    requires range<Rng>) auto insert_impl(Cont && cont, I p, Rng && rng,
                                                          eastl::false_type)
                    -> decltype(unwrap_reference(cont).insert(
                ...
                template(typename Cont, typename I, typename Rng)(
                    requires random_access_reservable<Cont> AND
                        sized_range<Rng>) auto insert_impl(Cont && cont_, I p, Rng && rng,
                                                           eastl::true_type)
                    -> decltype(unwrap_reference(cont_).insert(
            ...
            template(typename Cont, typename P, typename I, typename S)(
                ...
                -> decltype(detail::insert_impl(
                    static_cast<Cont &&>(cont), static_cast<P &&>(p),
                    static_cast<I &&>(i), static_cast<S &&>(j),
            ...
            template(typename Cont, typename I, typename Rng)(
                requires lvalue_container_like<Cont> AND input_iterator<I> AND
                    range<Rng>) auto insert(Cont && cont, I p, Rng && rng)
                -> decltype(detail::insert_impl(
            ...
            struct insert_fn
            {
                ...
                template(typename Rng,
                         typename T)(requires range<Rng> AND(!range<T>)
                                         AND constructible_from<range_value_t<Rng>, T>)
                ...
                template(typename Rng, typename Rng2)(requires range<Rng> AND range<Rng2>)
                    insert_result_t<Rng, Rng2>
                    operator()(Rng && rng, Rng2 && rng2) const
                {
                    static_assert(
                ...
                {
                    return insert(
                        static_cast<Rng &&>(rng), eastl::move(i), eastl::move(j));
                }

                template(typename Rng, typename I, typename T)(
                    requires range<Rng> AND input_iterator<I> AND(!range<T>)
                        AND constructible_from<range_value_t<Rng>, T>)
                    insert_result_t<Rng, I, T>
                    operator()(Rng && rng, I p, T && t) const
                {
                    return insert(
                ...
                template(typename Rng, typename I,
                         typename Rng2)(requires range<Rng> AND input_iterator<I> AND
                                            range<Rng2>) insert_result_t<Rng, I, Rng2>
                operator()(Rng && rng, I p, Rng2 && rng2) const
                {
                    static_assert(
                        !is_infinite<Rng>::value,
                        "Attempting to insert an infinite range into a container");
                    return insert(static_cast<Rng &&>(rng),
                                  eastl::move(p),
                                  static_cast<Rng2 &&>(rng2));
                }

                template(typename Rng, typename I,
                         typename T)(requires range<Rng> AND input_iterator<I>)
                ...
                template(typename Rng, typename I, typename N, typename T)(
                    ...
                    operator()(Rng && rng, I p, N n, T && t) const
                {
                    return insert(static_cast<Rng &&>(rng),
                                  eastl::move(p),
                                  n,
