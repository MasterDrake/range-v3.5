...
#ifndef EARANGES_ACTION_STABLE_SORT_HPP
#define EARANGES_ACTION_STABLE_SORT_HPP
...
namespace eastl
{
    namespace ranges
    {
        ...
        namespace actions
        {
            struct stable_sort_fn
            {
                ...
                operator()(C pred, P proj = P{}) const
                {
                    return make_action_closure(bind_back(
                        stable_sort_fn{}, eastl::move(pred), eastl::move(proj)));
                }
            ...
            /// \sa action_closure
            EARANGES_INLINE_VARIABLE(action_closure<stable_sort_fn>, stable_sort)
        } // namespace actions
        /// @}
    } // namespace ranges
} // namespace eastl
