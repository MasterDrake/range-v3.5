...
namespace ranges
{
    ...
    private:
        ...
        static meta::_t<eastl::add_pointer<R>> operator_arrow_(J const & j, long) noexcept
        {
            auto && r = *j;
    ...
    public:
        ...
        auto operator->() const //
            noexcept(
                noexcept(common_iterator::operator_arrow_(eastl::declval<I const &>(), 42)))
            -> decltype(common_iterator::operator_arrow_(eastl::declval<J const &>(), 42))
        {
    ...
    namespace detail
    {
        ...
        template(typename I)(requires derived_from<
