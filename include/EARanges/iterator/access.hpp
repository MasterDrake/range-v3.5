...
namespace eastl
{
    namespace ranges
    {
        ...
        namespace _iter_move_
        {
            ...
            template<typename T>
            EARANGES_INLINE_VAR constexpr bool is_adl_indirectly_movable_v =
                !EARANGES_IS_SAME(void, decltype(_iter_move_::try_adl_iter_move_<T>(42)));
        ...
        namespace detail
        {
            ...
            auto is_indirectly_movable_(I & (*i)(), O & (*o)(),
                                        iter_value_t<I> * v = nullptr)
                -> always_<eastl::true_type, decltype(iter_value_t<I>(iter_move(i()))),
        ...
        namespace _iter_swap_
        {
            ...
            template<typename T, typename U>
            decltype(iter_swap(eastl::declval<T>(), eastl::declval<U>()))
            ...
            struct fn
            {
                ...
                template<typename T, typename U>
                constexpr detail::enable_if_t<is_adl_indirectly_swappable_v<T, U>>
                ...
                constexpr detail::enable_if_t<
                    !is_adl_indirectly_swappable_v<I0, I1> &&
                    !is_swappable_with<iter_reference_t<I0>,
        ...
        namespace detail
        {
            ...
            auto is_nothrow_indirectly_swappable_(int)
                -> meta::bool_<noexcept(iter_swap(eastl::declval<T &>(),
                                                  eastl::declval<U &>()))>;
            template<typename T, typename U>
