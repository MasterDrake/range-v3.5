...
#ifndef EARANGES_ITERATOR_DIFFMAX_T_HPP
#define EARANGES_ITERATOR_DIFFMAX_T_HPP
    ...
    namespace ranges
{
    ...
    namespace detail
    {
        ...
        private:
            ...
            constexpr diffmax_t(tag, bool neg, std::uintmax_t val) : neg_(val && neg), val_(val)
            {}

            /// \cond
            constexpr void _check()
            {
                EARANGES_ENSURE(!neg_ || val_);
            }
        ...
        public:
            ...
            template<typename T>
            friend constexpr auto operator+=(T & a, diffmax_t b) noexcept -> CPP_broken_friend_ret(T &)(requires integral<T>)
            {
            ...
            friend auto operator<<(Ostream & sout, diffmax_t a) -> CPP_broken_friend_ret(std::ostream &)(requires derived_from<Ostream, std::basic_ostream<typename Ostream::char_type, typename Ostream::traits_type>>)
            {
...
EARANGES_DIAGNOSTIC_IGNORE_MISMATCHED_TAGS
    ...
    struct numeric_limits<::ranges::detail::diffmax_t>
    {
        ...
        static constexpr eastl::float_round_style round_style = eastl::round_toward_zero;
    ...
    template<>
    struct numeric_limits<::ranges::detail::diffmax_t const> : numeric_limits<::ranges::detail::diffmax_t>
    {};
    template<>
    struct numeric_limits<::ranges::detail::diffmax_t volatile> : numeric_limits<::ranges::detail::diffmax_t>
    {};
    template<>
    struct numeric_limits<::ranges::detail::diffmax_t const volatile> : numeric_limits<::ranges::detail::diffmax_t>
    {};
	...
	inline constexpr eastl::float_denorm_style numeric_limits<::ranges::detail::diffmax_t>::has_denorm;
    inline constexpr bool numeric_limits<::ranges::detail::diffmax_t>::has_denorm_loss;
    inline constexpr eastl::float_round_style numeric_limits<::ranges::detail::diffmax_t>::round_style;
