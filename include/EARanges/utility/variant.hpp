    ...
    namespace ranges
    {
        ...
        namespace detail
        {
            ...
            public:
                ...
                template(typename I,
                         typename S)(requires sentinel_for<S, I> AND input_iterator<I> AND
                ...
                template(typename R)(
                    requires input_range<R> AND constructible_from<
                        T, range_reference_t<R>>) explicit indexed_datum(R && r)
                ...
                template(typename R)(requires input_range<R> AND
                                         assignable_from<T &, range_reference_t<R>>)
                    indexed_datum &
                    operator=(R && r)
                {
                    ranges::copy(r, data_);
