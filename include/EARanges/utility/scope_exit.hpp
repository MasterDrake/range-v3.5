...
//
#ifndef EARANGES_UTILITY_SCOPE_EXIT_HPP
#define EARANGES_UTILITY_SCOPE_EXIT_HPP
...
namespace eastl
{
    namespace ranges
    {
        ...
        public:
            ...
            explicit scope_exit(Fun && fun) noexcept(
                noexcept(scope_exit(eastl::move(fun), nothrow_move_t{})))
            ...
            scope_exit(scope_exit && that) noexcept(
              ...
              : scope_exit(eastl::move((that.dismiss(), that)).fun_)
            {}
        ...
        template<typename Fun,
                 typename ScopeExit = scope_exit<meta::_t<eastl::decay<Fun>>>>
