...
namespace ranges
{
    ...
    namespace compressed_tuple_detail
    {
          ...
          : storage<Ts, Is, Ts...>...
        {
            ...
            template<typename... Args, meta::if_<meta::and_c<META_IS_CONSTRUCTIBLE(Ts, Args)...>, int> = 0>
            constexpr compressed_tuple_(Args &&... args) noexcept(meta::strict_and<eastl::is_nothrow_constructible<storage<Ts, Is, Ts...>,Args>...>::value)
            ...
            constexpr operator eastl::tuple<Us...>() const noexcept(
                meta::strict_and<eastl::is_nothrow_constructible<Us, Ts const &>...>::value)
            {
                return eastl::tuple<Us...>{get<Is>(*this)...};
            }
        ...
        using compressed_tuple EARANGES_DEPRECATED(
    ...
    EARANGES_INLINE_VARIABLE(make_compressed_tuple_fn, make_compressed_tuple)
