...
namespace eastl
{
    namespace ranges
    {
        ...
        namespace detail
        {
            ...
            using begin_cursor_t = detail::decay_t<decltype(range_access::begin_cursor(
                eastl::declval<Derived &>()))>;

            template<typename Derived>
            using end_cursor_t = detail::decay_t<decltype(range_access::end_cursor(
                eastl::declval<Derived &>()))>;
        ...
        public:
            ...
            template(typename D = Derived)(
                requires same_as<D, Derived>) constexpr auto begin()
            ...
            /// \overload
            template(typename D = Derived)(
                requires same_as<D, Derived>) constexpr auto begin() const
                -> detail::facade_iterator_t<D const>
            {
            ...
            template(typename D = Derived)(
                requires same_as<D, Derived>) constexpr auto end()
            ...
            /// \overload
            template(typename D = Derived)(
                requires same_as<D, Derived>) constexpr auto end() const
                -> detail::facade_sentinel_t<D const>
            {
