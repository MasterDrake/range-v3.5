...
namespace ranges
{
    ...
    private:
        ...
        {
            static_assert((get_categories<Rng>() & Cat) == Cat, "The range passed to any_view() does not model the requested category");
        }
                    ...
                    (Cat & category::sized) == category::sized ? finite : unknown>
    {
        ...
        template(typename Rng)(
            requires //
                ...
                detail::any_compatible_range<Rng, Ref>)
        any_view(Rng && rng)
          : ptr_{eastl::make_shared<impl_t<Rng>>(views::all(static_cast<Rng &&>(rng)))}
        {}
    ...
    private:
        template<typename Rng>
        using impl_t = detail::any_input_view_impl<views::all_t<Rng>, Ref, (Cat & category::sized) == category::sized>;
        ...
        eastl::shared_ptr<detail::any_input_view_interface<Ref, (Cat & category::sized) == category::sized>> ptr_;
    };
