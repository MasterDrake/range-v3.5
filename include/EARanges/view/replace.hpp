        ...
        namespace views
        {
                ...
                template(typename Rng, typename Val1, typename Val2)(
                    requires viewable_range<Rng> AND input_range<Rng> AND same_as<
                        ...
                        AND equality_comparable_with<
                            detail::decay_t<unwrap_reference_t<Val1>>, range_value_t<Rng>>
                            AND common_with<
                                detail::decay_t<unwrap_reference_t<Val2 const &>>,
                                range_value_t<Rng>>
            ...
            struct replace_fn : replace_base_fn
            {
                ...
                template(typename Val1, typename Val2)(
                    requires same_as<
                        detail::decay_t<unwrap_reference_t<Val1>>,
                        detail::decay_t<unwrap_reference_t<Val2>>>) constexpr auto
                operator()(Val1 old_value, Val2 new_value) const
                {
                    return make_view_closure(bind_back(replace_base_fn{},
                                                       eastl::move(old_value),
                                                       eastl::move(new_value)));
                }
            };
