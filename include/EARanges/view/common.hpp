...
//
#ifndef EARANGES_VIEW_COMMON_HPP
#define EARANGES_VIEW_COMMON_HPP
...
namespace eastl
{
    namespace ranges
    {
        ...
        public:
            ...
            template(bool Const = true)(
                requires range<meta::const_if_c<Const, Rng>>) auto begin() const
            ...
            template(bool Const = true)(
                requires range<meta::const_if_c<Const, Rng>>) auto end() const
                -> detail::common_view_iterator_t<meta::const_if_c<Const, Rng>>
            {
                return detail::common_view_iterator_t<meta::const_if_c<Const, Rng>>{
        ...
        EARANGES_INLINE_VAR constexpr bool enable_borrowed_range<common_view<Rng, B>> = //
            enable_borrowed_range<Rng>;

#if EARANGES_CXX_DEDUCTION_GUIDES >= EARANGES_CXX_DEDUCTION_GUIDES_17
        template(typename Rng)(requires(!common_range<Rng>)) //
        ...
        namespace views
        {
            ...
            {
                template(typename Rng)(
                    requires viewable_range<Rng> AND common_range<Rng>) all_t<Rng>
            ...
            /// \relates common_fn
            /// \ingroup group-views
            EARANGES_INLINE_VARIABLE(view_closure<common_fn>, common)
        } // namespace views
        /// @}
...
EARANGES_SATISFY_BOOST_RANGE(::ranges::common_view)
