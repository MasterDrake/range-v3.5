...
//
#ifndef EARANGES_VIEW_C_STR_HPP
#define EARANGES_VIEW_C_STR_HPP
        ...
        namespace views
        {
            ...
            struct c_str_fn
            {
                ...
                template(typename Char,
                         std::size_t N)(requires detail::is_char_type<Char>::value) //
                    ranges::subrange<Char *>
                    operator()(Char (&sz)[N]) const
                {
                    return {&sz[0], &sz[N - 1]};
                }
            ...
            /// \relates c_str_fn
            /// \ingroup group-views
            EARANGES_INLINE_VARIABLE(c_str_fn, c_str)
        } // namespace views
    }     // namespace ranges
} // namespace eastl
