...
#ifndef EARANGES_VIEW_TRANSFORM_HPP
#define EARANGES_VIEW_TRANSFORM_HPP
...
namespace eastl
{
    namespace ranges
    {
        ...
        namespace detail
        {
            constexpr cardinality transform2_cardinality(cardinality c1, cardinality c2)
            {
                return c1 >= 0 || c2 >= 0
                       ...
                       : c1 == finite || c2 == finite   ? finite
                       : c1 == unknown || c2 == unknown ? unknown
                                                        : infinite;
            }
        ...
        private:
            ...
            template<bool Const>
            using use_sentinel_t = meta::bool_<
            ...
            private:
                ...
                EARANGES_NO_UNIQUE_ADDRESS fun_ref_ fun_;
            ...
            template(bool Const = true)(
                requires Const AND range<meta::const_if_c<Const, Rng>> AND
                    detail::iter_transform_1_readable<Fun const,
                                                      meta::const_if_c<Const, Rng>>)
                meta::if_<use_sentinel_t<Const>, adaptor_base,
                          adaptor<Const>> end_adaptor() const
            {
                return {fun_};
            }
        ...
        public:
            ...
            iter_transform_view(Rng rng, Fun fun)
              : iter_transform_view::view_adaptor{eastl::move(rng)}
              , fun_(eastl::move(fun))
            {}
        ...
        struct transform_view : iter_transform_view<Rng, indirected<Fun>>
        {
            ...
            transform_view(Rng rng, Fun fun)
              : iter_transform_view<Rng, indirected<Fun>>{eastl::move(rng),
                                                          indirect(eastl::move(fun))}
            {}
        };
        ...
        private:
            ...
            public:
                ...
                template(bool Other)(requires Const AND CPP_NOT(Other)) //
                  ...
                  : end1_(eastl::move(that.end1_))
                  , end2_(eastl::move(that.end2_))
                {}
            };
            ...
            public:
                ...
                using single_pass =
                    meta::or_c<(bool)single_pass_iterator_<iterator_t<R1>>,
                               (bool)single_pass_iterator_<iterator_t<R2>>>;
                using value_type = detail::decay_t<
                    invoke_result_t<meta::const_if_c<Const, Fun> &, copy_tag,
                ...
                template(bool Other)(requires Const AND CPP_NOT(Other)) //
                  ...
                  : fun_(eastl::move(that.fun_))
                  , it1_(eastl::move(that.end1_))
                  , it2_(eastl::move(that.end2_))
                {}
                // clang-format off
            ...
            (
                ...
                auto equal(cursor const & that) const //
                    -> CPP_ret(bool)(requires forward_range<Rng1> && forward_range<Rng2>)
                {
                    // By returning true if *any* of the iterators are equal, we allow
                    // transformed ranges to be of different lengths, stopping when the
                    // first one reaches the last.
            ...
            template(bool Const = true)(
                requires Const AND range<meta::const_if_c<Const, Rng1>> AND
                    range<meta::const_if_c<Const, Rng2>>
                        AND detail::iter_transform_2_readable< //
                            Fun const,                         //
                            meta::const_if_c<Const, Rng1>,     //
                            meta::const_if_c<Const, Rng2>>) cursor<true> begin_cursor()
                const
            {
                return {this, ranges::begin};
            }
        ...
        public:
            ...
            constexpr iter_transform2_view(Rng1 rng1, Rng2 rng2, Fun fun)
              : fun_(eastl::move(fun))
              , rng1_(eastl::move(rng1))
              , rng2_(eastl::move(rng2))
            {}
            CPP_member
            ...
            template(bool True = true)(
                requires(my_cardinality < 0) AND sized_range<Rng1 const> AND
                    sized_range<Rng2 const>
                        AND common_with<range_size_t<R1<True>>,
                                        range_size_t<R2<True>>>) constexpr auto size()
                const
            {
                return size_(*this);
            }
            template(bool True = true)(
                requires(my_cardinality < 0) AND sized_range<Rng1> AND sized_range<Rng2>
                    AND common_with<range_size_t<R1<True>>,
                                    range_size_t<R2<True>>>) constexpr auto size()
            {
                return size_(*this);
                ...
                template(typename Rng, typename Fun)(
                    requires viewable_range<Rng> AND input_range<Rng> AND
                        copy_constructible<Fun>
                            AND detail::iter_transform_1_readable<
                                Fun, Rng>) constexpr iter_transform_view<all_t<Rng>,
                                                                         Fun> //
                    ...
                    requires viewable_range<Rng1> AND input_range<Rng1> AND viewable_range<
                        ...
                        AND input_range<Rng2>
                            AND copy_constructible<Fun>
                                AND common_with<range_difference_t<Rng1>,
                                                range_difference_t<Rng1>>
                                    AND detail::iter_transform_2_readable<
                                        Fun, Rng1,
                                        Rng2>) constexpr iter_transform2_view<all_t<Rng1>,
                                                                              all_t<Rng2>,
                                                                              Fun> //
            ...
            struct iter_transform_fn : iter_transform_base_fn
            {
                ...
                constexpr auto operator()(Fun fun) const
                {
                    return make_view_closure(
                        bind_back(iter_transform_base_fn{}, eastl::move(fun)));
                }
            };

            /// \relates iter_transform_fn
            /// \ingroup group-views
            EARANGES_INLINE_VARIABLE(iter_transform_fn, iter_transform)
        ...
        concept (transformable_range_)(Rng, Fun),
            ...
            (!eastl::is_void<indirect_result_t<Fun &, iterator_t<Rng>>>::value)
        );
        ...
        concept (transformable_ranges_)(Rng1, Rng2, Fun),
            ...
            (!eastl::is_void<indirect_result_t<Fun &, iterator_t<Rng1>, iterator_t<Rng2>>>::value)
        );
        ...
        CPP_concept transformable_ranges =
            ...
            {
                template(typename Rng, typename Fun)(
                    requires transformable_range<
                        Rng, Fun>) constexpr transform_view<all_t<Rng>, Fun>
                operator()(Rng && rng, Fun fun) const
                {
                    return {all(static_cast<Rng &&>(rng)), eastl::move(fun)};
                }
                ...
                template(typename Rng1, typename Rng2, typename Fun)(
                    requires transformable_ranges<
                        Rng1, Rng2, Fun>) constexpr transform2_view<all_t<Rng1>,
                                                                    all_t<Rng2>, Fun> //
                operator()(Rng1 && rng1, Rng2 && rng2, Fun fun) const
                {
                    return {all(static_cast<Rng1 &&>(rng1)),
            ...
            /// ## Syntax
            /// ```cpp
            /// auto output_range = input_range |
            /// ranges::views::transform(transform_func);
            /// ```
            ///
            /// ## Parameters
            ...
            ///   contiguous ranges). Contiguous ranges are reduced to random access
            ///   ranges.
            ///
            struct transform_fn : transform_base_fn
            {
                ...
                {
                    return make_view_closure(
                        bind_back(transform_base_fn{}, eastl::move(fun)));
                }
            };
...
EARANGES_SATISFY_BOOST_RANGE(::ranges::iter_transform_view)
EARANGES_SATISFY_BOOST_RANGE(::ranges::transform_view)
