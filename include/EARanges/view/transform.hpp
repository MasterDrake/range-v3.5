...
namespace ranges
{
    ...
    private:
        ...
        static constexpr cardinality my_cardinality = detail::transform2_cardinality(range_cardinality<Rng1>::value, range_cardinality<Rng2>::value);
    ...
    struct transform2_view : iter_transform2_view<Rng1, Rng2, indirected<Fun>>
    {
        ...
        constexpr transform2_view(Rng1 rng1, Rng2 rng2, Fun fun)
          : iter_transform2_view<Rng1, Rng2, indirected<Fun>>{eastl::move(rng1),
                                                              eastl::move(rng2),
                                                              indirect(eastl::move(fun))}
        {}
    };
    ...
    namespace views
    {
        ...
        struct iter_transform_fn : iter_transform_base_fn
        {
            ...
            {
                return make_view_closure(bind_back(iter_transform_base_fn{}, eastl::move(fun)));
            }
        };
        ...
        struct transform_base_fn
        {
            ...
            operator()(Rng1 && rng1, Rng2 && rng2, Fun fun) const
            {
                return {all(static_cast<Rng1 &&>(rng1)), all(static_cast<Rng2 &&>(rng2)), eastl::move(fun)};
            }
        };
        ...
        struct transform_fn : transform_base_fn
        {
            ...
            constexpr auto operator()(Fun fun) const
            {
                return make_view_closure(bind_back(transform_base_fn{}, eastl::move(fun)));
            }
        };
