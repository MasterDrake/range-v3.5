...
#ifndef EARANGES_VIEW_ZIP_HPP
#define EARANGES_VIEW_ZIP_HPP
...
namespace eastl
{
    namespace ranges
    {
        ...
        namespace detail
        {
            ...
            {
                // tuple value
                template(typename... Its)(requires(sizeof...(Its) != 2)
                                              AND and_v<indirectly_readable<Its>...>)
                    eastl::tuple<iter_value_t<Its>...>
                ...
                {
                    return common_tuple<iter_rvalue_reference_t<Its>...>{
                        iter_move(its)...};
                }
        ...
        namespace views
        {
            struct zip_fn
            {
                ...
                template(typename... Rngs)(requires and_v<viewable_range<Rngs>...> AND
                ...
                template(typename Rng0)(
                    requires input_range<Rng0> AND
                        viewable_range<Rng0>) constexpr zip_view<all_t<Rng0>>
                ...
                template(typename Rng0, typename Rng1)(
                    requires input_range<Rng0> AND viewable_range<Rng0> AND
                        input_range<Rng1>
                            AND viewable_range<Rng1>) constexpr zip_view<all_t<Rng0>,
                                                                         all_t<Rng1>> //
                ...
                template(typename Rng0, typename Rng1, typename Rng2)(
                    requires input_range<Rng0> AND viewable_range<Rng0> AND input_range<
                        Rng1>
                        AND viewable_range<Rng1>
                            AND input_range<Rng2>
                                AND viewable_range<
                                    Rng2>) constexpr zip_view<all_t<Rng0>, all_t<Rng1>,
                                                              all_t<Rng2>> //
            ...
            /// \relates zip_fn
            /// \ingroup group-views
            EARANGES_INLINE_VARIABLE(zip_fn, zip)
        } // namespace views
        /// @}
    } // namespace ranges
} // namespace eastl
