...
#ifndef EARANGES_VIEW_MAP_HPP
#define EARANGES_VIEW_MAP_HPP
...
// TODO: Reuse subrange's pair_like concept here and have get_first and get_second dispatch through get<>() - Eric Niebler
namespace eastl
{
    namespace ranges
    {
        ...
        namespace detail
        {
            ...
            template(typename T)(requires move_constructible<T>) constexpr T
                get_first_second_helper(T & t, eastl::false_type) //
            ...
            using get_first_second_tag =
                meta::bool_<eastl::is_lvalue_reference<P>::value ||
                            eastl::is_lvalue_reference<E>::value>;
        ...
        namespace views
        {
            ...
            /// \relates keys_fn
            /// \ingroup group-views
            EARANGES_INLINE_VARIABLE(view_closure<keys_fn>, keys)

            /// \relates values_fn
            /// \ingroup group-views
            EARANGES_INLINE_VARIABLE(view_closure<values_fn>, values)
        } // namespace views

        template<typename Rng>
        EARANGES_INLINE_VAR constexpr bool enable_borrowed_range<keys_range_view<Rng>> =
            enable_borrowed_range<Rng>;
        template<typename Rng>
        EARANGES_INLINE_VAR constexpr bool enable_borrowed_range<values_view<Rng>> =
            enable_borrowed_range<Rng>;
