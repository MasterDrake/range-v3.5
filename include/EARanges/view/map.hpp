...
// TODO: Reuse subrange's pair_like concept here and have get_first and get_second dispatch through get<>()
...
namespace ranges
{
    ...
    EARANGES_INLINE_VAR constexpr bool enable_borrowed_range<keys_range_view<Rng>> = enable_borrowed_range<Rng>;
    template<typename Rng>
    EARANGES_INLINE_VAR constexpr bool enable_borrowed_range<values_view<Rng>> =  enable_borrowed_range<Rng>;
