    ...
    namespace ranges
    {
        ...
        public:
            ...
            template(bool Const = true)(
                requires Const AND common_range<meta::const_if_c<
                    Const,
                    Rng>>) constexpr reverse_iterator<iterator_t<meta::
                                                                     const_if_c<
                                                                         Const,
                                                                         Rng>>> begin()
                const
        ...
        struct reverse_view<reverse_view<Rng>> : Rng
        {
            ...
            CPP_assert(
                same_as<
                    detail::decay_t<decltype(eastl::declval<reverse_view<Rng>>().base())>,
                    Rng>);
        ...
        template<typename Rng>
        EARANGES_INLINE_VAR constexpr bool enable_borrowed_range<reverse_view<Rng>> =
            ...
            struct reverse_fn
            {
                template(typename Rng)(
                    requires viewable_range<Rng> AND
                        bidirectional_range<Rng>) constexpr reverse_view<all_t<Rng>>
