    ...
    namespace ranges
    {
        ...
        private:
            ...
            private:
                ...
                using reference_ = indirect_view<
                    take_while_view<iota_view<iterator_t<CRng>>, search_pred>>;
            ...
            public:
                ...
                template(bool Other)(requires IsConst AND CPP_NOT(Other)) //
                  ...
                  : cursor{eastl::move(that.cur_),
                           eastl::move(that.last_),
                           eastl::move(that.fun_)}
                {}
            };
        ...
        namespace views
        {
            ...
            private:
                ...
                struct predicate_pred_
                {
                    ...
                    template(typename I,
                             typename S)(requires sentinel_for<S, I>) eastl::pair<bool, I>
                    operator()(I cur, S last) const
                    {
            ...
            public:
                template(typename Rng, typename Fun)(
                    requires viewable_range<Rng> AND forward_range<Rng> AND invocable<
                        Fun &, iterator_t<Rng>, sentinel_t<Rng>>
                    ...
                    operator()(Rng && rng, Fun fun) const
                {
                    return {all(static_cast<Rng &&>(rng)),
                            predicate_pred_<Fun>{eastl::move(fun)}};
                }
            };
