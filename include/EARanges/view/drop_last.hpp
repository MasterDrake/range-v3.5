...
namespace eastl
{
    namespace ranges
    {
        ...
        namespace detail
        {
            namespace drop_last_view
            {
                ...
                constexpr mode_enum get_mode() noexcept
                {
                    ...
                    // max performance
                    // Sized Bidi O(1)
                    // Sized Bidi use mode::sized instead of mode::bidi - thus become
                    // unbound.
                    /*return (random_access_range<Rng> && view_<Rng> && sized_range<Rng>
                       ...
                       && common_range<Rng> && view_<Rng> ? mode::bidi :
                       forward_range<Rng> && view_<Rng> ? mode::forward : mode::invalid;*/
                }
        ...
        {
            CPP_assert((random_access_range<Rng> && view_<Rng> && sized_range<Rng>) ||
        ...
        struct drop_last_view<Rng, detail::drop_last_view::mode_sized>
          : view_interface<drop_last_view<Rng, detail::drop_last_view::mode_sized>,
                           finite>
        {
        ...
        public:
            ...
            template(typename CRng = Rng const)(requires sized_range<CRng>)
        ...
        namespace views
        {
            ...
            {
                template(typename Rng)(requires sized_range<Rng> ||
                                       forward_range<Rng>) constexpr auto
