    ...
    namespace ranges
    {
        ...
        namespace detail
        {
            ...
            public:
                ...
                CPP_auto_member auto CPP_fun(begin)()(const //
                                                      requires range<Rng const>)
                {
                    return ranges::begin(rng_);
                }
                CPP_auto_member auto CPP_fun(end)()(const //
                                                    requires range<Rng const>)
                {
                    return ranges::begin(rng_) + n_;
                }
        ...
        namespace views
        {
            ...
            private:
                ...
                template(typename Rng)(requires borrowed_range<Rng>) static constexpr subrange<
                    iterator_t<Rng>> impl_(Rng && rng, range_difference_t<Rng> n,
