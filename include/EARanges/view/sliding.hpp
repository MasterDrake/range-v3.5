    ...
    namespace ranges
    {
        ...
        namespace sliding_view_detail
        {
            ...
            using caching = eastl::integral_constant<
                cache, random_access_range<Rng> && sized_range<Rng>    ? cache::none
        ...
        namespace sliding_view_detail
        {
            template<typename Rng>
            using uncounted_t =
                decltype(ranges::uncounted(eastl::declval<iterator_t<Rng> &>()));
            ...
            private:
                using cache_t =
                    detail::non_propagating_cache<iterator_t<Rng>, sv_base<Rng>>;
            };
        } // namespace sliding_view_detail
        /// \endcond
        ...
        private:
            ...
            iterator_t<Rng> get_first()
            {
                ...
                if(!first)
                {
                    first = ranges::next(ranges::begin(this->base()),
                                         this->n_ - 1,
        ...
        private:
            ...
            iterator_t<Rng> get_last()
            {
                ...
                if(!last)
                {
                    last = ranges::prev(ranges::end(this->base()),
                                        this->n_ - 1,
        ...
        namespace views
        {
            ...
            struct sliding_base_fn
            {
                template(typename Rng)(
                    requires viewable_range<Rng> AND
                        forward_range<Rng>) constexpr sliding_view<all_t<Rng>> //
            ...
            struct sliding_fn : sliding_base_fn
            {
                ...
                constexpr auto CPP_fun(operator())(Int n)(
                    const //
