...
namespace eastl
{
    namespace ranges
    {
        ...
        class sample_view : public view_facade<sample_view<Rng, URNG>, finite>
        {
            ...
            template(bool Const = true)(requires Const AND(
        ...
        namespace views
        {
            ...
            struct sample_base_fn
            {
                template(typename Rng, typename URNG = detail::default_random_engine)(
                    requires viewable_range<Rng> AND input_range<Rng> AND
                        uniform_random_bit_generator<URNG>
                            AND convertible_to<invoke_result_t<URNG &>,
                                               range_difference_t<Rng>>
                                AND(sized_range<Rng> ||
                                    sized_sentinel_for<sentinel_t<Rng>,
                                                       iterator_t<Rng>> ||
                                    forward_range<Rng>)) //
            ...
            struct sample_fn : sample_base_fn
            {
                ...
                template(typename Size, typename URNG = detail::default_random_engine)(
                    requires integral<Size> AND
                        uniform_random_bit_generator<URNG>) constexpr auto
                operator()(Size n,
