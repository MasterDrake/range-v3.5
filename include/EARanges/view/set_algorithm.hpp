...
#ifndef EARANGES_VIEW_SET_ALGORITHM_HPP
#define EARANGES_VIEW_SET_ALGORITHM_HPP
...
namespace eastl
{
    namespace ranges
    {
        ...
        namespace detail
        {
            ...
            public:
                ...
                set_algorithm_view(Rng1 rng1, Rng2 rng2, C pred, P1 proj1, P2 proj2)
                  ...
                  , proj1_(eastl::move(proj1))
                  , proj2_(eastl::move(proj2))
            ...
            public:
                ...
                set_difference_cursor(pred_ref_ pred, proj1_ref_ proj1, proj2_ref_ proj2,
                  ...
                  , proj2_(eastl::move(proj2))
                  , it1_(eastl::move(it1))
                  , end1_(eastl::move(end1))
                  , it2_(eastl::move(it2))
                  , end2_(eastl::move(end2))
                {
                    satisfy();
                }
                template(bool Other)(requires IsConst && CPP_NOT(Other)) //
                  ...
                  , proj1_(eastl::move(that.proj1_))
                  , proj2_(eastl::move(that.proj2_))
                  , it1_(eastl::move(that.it1_))
                  , end1_(eastl::move(that.end1_))
                  , it2_(eastl::move(that.it2_))
            ...
            (
                ...
                auto equal(set_difference_cursor const & that) const //
                    -> CPP_ret(bool)(requires forward_range<Rng1>)
                {
            ...
            constexpr cardinality set_difference_cardinality(cardinality c1,
                                                             cardinality c2)
            {
                return (c1 == unknown)               ? unknown
                       : (c1 >= 0) || (c1 == finite) ? finite
                                                     : // else, c1 == infinite
                           (c2 >= 0) || (c2 == finite) ? infinite
                                                       : unknown;
            }
        } // namespace detail
        /// \endcond
        ...
        template<typename Rng1, typename Rng2, typename C, typename P1, typename P2>
        using set_difference_view = detail::set_algorithm_view<
            Rng1, Rng2, C, P1, P2, detail::set_difference_cursor,
            detail::set_difference_cardinality(range_cardinality<Rng1>::value,
        ...
        namespace views
        {
                            ...
                            AND viewable_range<Rng2>
                                AND input_range<Rng2>
                                    AND indirect_relation<
                                        C, projected<iterator_t<Rng1>, P1>,
            ...
            struct set_difference_fn : set_difference_base_fn
            {
                ...
                template(typename Rng2, typename C = less, typename P1 = identity,
                    ...
                    requires viewable_range<Rng2> AND input_range<Rng2> AND(
                        !range<C>)) constexpr auto
                operator()(Rng2 && rng2, C && pred = C{}, P1 proj1 = P1{},
                           P2 proj2 = P2{}) const
                {
            ...
            EARANGES_INLINE_VARIABLE(set_difference_fn, set_difference)
        } // namespace views
        ...
        namespace detail
        {
            ...
            private:
                ...
                void satisfy()
                {
                    while(it1_ != end1_ && it2_ != end2_)
                    {
                        ...
                        {
                            if(!invoke(
                                   pred_, invoke(proj2_, *it2_), invoke(proj1_, *it1_)))
                                return;
                            ++it2_;
                        }
                    }
            ...
            public:
                ...
                set_intersection_cursor(pred_ref_ pred, proj1_ref_ proj1,
            ...
            constexpr cardinality set_intersection_cardinality(cardinality c1,
                                                               cardinality c2)
            {
        ...
        template<typename Rng1, typename Rng2, typename C, typename P1, typename P2>
        using set_intersection_view = detail::set_algorithm_view<
            Rng1, Rng2, C, P1, P2, detail::set_intersection_cursor,
            detail::set_intersection_cardinality(range_cardinality<Rng1>::value,
                                                 range_cardinality<Rng2>::value)>;
        ...
        namespace views
        {
            struct set_intersection_base_fn
            {
                template(typename Rng1, typename Rng2, typename C = less,
                    ...
                    requires viewable_range<Rng1> AND input_range<Rng1> AND
                        viewable_range<Rng2>
                            AND input_range<Rng2>
                                AND indirect_relation<C, projected<iterator_t<Rng1>, P1>,
                                                      projected<iterator_t<Rng2>, P2>>)
            ...
            EARANGES_INLINE_VARIABLE(set_intersection_fn, set_intersection)
        } // namespace views
        ...
        namespace views
        {
                ...
                template(typename Rng1, typename Rng2, typename C = less,
                    ...
                    viewable_range<Rng1>
                        AND input_range<Rng1>
                            AND viewable_range<Rng2>
                                AND input_range<Rng2>
                                    AND common_with<range_value_t<Rng1>,
                                                    range_value_t<Rng2>>
                                        AND common_reference_with<range_reference_t<Rng1>,
                                                                  range_reference_t<Rng2>>
                                            AND common_reference_with<
                                                range_rvalue_reference_t<Rng1>,
            ...
            EARANGES_INLINE_VARIABLE(set_union_fn, set_union)
        } // namespace views
        ...
        namespace detail
        {
            ...
            public:
                ...
                template(bool Other)(requires IsConst && CPP_NOT(Other)) //
                    set_symmetric_difference_cursor(
                        set_symmetric_difference_cursor<Other, Rng1, Rng2, C, P1, P2>
                            that)
                  : pred_(eastl::move(that.pred_))
                  , proj1_(eastl::move(that.proj1_))
                  , proj2_(eastl::move(that.proj2_))
                ...
                auto equal(set_symmetric_difference_cursor const & that) const
                    -> CPP_ret(bool)(requires forward_range<R1> && forward_range<R2>)
                {
                    // does not support comparing iterators from different ranges:
                    return (it1_ == that.it1_) && (it2_ == that.it2_);
                }
                                                                       ...
                                                                       cardinality c2)
            {
                return (c1 == unknown) || (c2 == unknown)     ? unknown
                       ...
                       : (c1 == infinite) && (c2 == infinite) ? unknown
                                                              : finite;
            }
        ...
        namespace views
        {
            ...
            EARANGES_INLINE_VARIABLE(set_symmetric_difference_fn,
