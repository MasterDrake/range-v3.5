...
namespace ranges
{
    ...
    namespace detail
    {
        template<typename Rng1, typename Rng2, typename C, typename P1, typename P2, template<bool, typename...> class Cursor, cardinality Cardinality>
        struct set_algorithm_view : view_facade<set_algorithm_view<Rng1, Rng2, C, P1, P2, Cursor, Cardinality>, Cardinality>
        {
        private:
            friend range_access;
            ...
            auto begin_cursor() const //
                -> CPP_ret(cursor<true>)(requires range<Rng1 const> && range<Rng2 const>)
            {
                return {pred_,
                        proj1_,
                        proj2_,
        ...
        public:
            ...
            using single_pass = meta::or_c<single_pass_iterator_<iterator_t<R1>>, single_pass_iterator_<iterator_t<R2>>>;
    ...
    namespace views
    {
        ...
        struct set_symmetric_difference_fn : set_symmetric_difference_base_fn
        {
            ...
            template(typename Rng2, typename C = less, typename P1 = identity, typename P2 = identity)(requires viewable_range<Rng2> AND input_range<Rng2> AND (!range<C>))
            constexpr auto operator()(Rng2 && rng2,
                                      C && pred = C{},
                                      P1 proj1 = P1{},
                                      P2 proj2 = P2{}) const
        ...
        EARANGES_INLINE_VARIABLE(set_symmetric_difference_fn, set_symmetric_difference)
    } // namespace views
    /// @}
} // namespace ranges
