...
namespace ranges
{
    ...
    private:
        ...
        {
            return simple_view<Rng>() && eastl::is_reference<range_reference_t<Rng>>::value;
        }
        ...
        template(bool Const = true)(
            requires Const AND input_range<meta::const_if_c<Const, Rng>> AND
                eastl::is_reference<range_reference_t<meta::const_if_c<Const, Rng>>>::value)
        ...
        {
            using cond =
                meta::bool_<eastl::is_reference<range_reference_t<Rng>>::value &&
        ...
        constexpr auto end_cursor() const
        {
            ...
            using cond =
                meta::bool_<eastl::is_reference<range_reference_t<CRng>>::value &&
                            forward_range<CRng> &&
