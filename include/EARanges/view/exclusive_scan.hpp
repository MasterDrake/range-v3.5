    ...
    CPP_concept exclusive_scan_constraints =
        ...
        private:
            ...
            private:
                ...
                using exclusive_scan_view_t =
                    meta::const_if_c<IsConst, exclusive_scan_view>;
        ...
        template(typename Rng, typename T,
                 typename Fun)(requires copy_constructible<T> AND copy_constructible<Fun>)
        ...
        namespace views
        {
            struct exclusive_scan_base_fn
            {
                template(typename Rng, typename T, typename Fun = plus)(
                    requires exclusive_scan_constraints<
                        Rng, T, Fun>) constexpr exclusive_scan_view<all_t<Rng>, T, Fun> //
            ...
            struct exclusive_scan_fn : exclusive_scan_base_fn
            {
                ...
                constexpr auto operator()(T init, Fun fun = {}) const
                {
                    return make_view_closure(bind_back(
                        exclusive_scan_base_fn{}, eastl::move(init), eastl::move(fun)));
                }
            };
