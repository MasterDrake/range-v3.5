...
#ifndef EARANGES_VIEW_ENUMERATE_HPP
#define EARANGES_VIEW_ENUMERATE_HPP
...
namespace eastl
{
    namespace ranges
    {
        ...
        EARANGES_INLINE_VAR constexpr bool
            enable_borrowed_range<detail::index_view<Size, Diff>> = true;
        ...
        namespace views
        {
            ...
            struct enumerate_fn
            {
                template(typename Rng)(requires viewable_range<Rng>) auto operator()(
                    Rng && rng) const
                {
            ...
            /// \ingroup group-views
            EARANGES_INLINE_VARIABLE(view_closure<enumerate_fn>, enumerate)
        } // namespace views
        /// @}
    } // namespace ranges
} // namespace eastl
