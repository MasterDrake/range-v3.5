...
int main()
{
...

    {
        ...
        static_assert(eastl::is_same<decltype(i), counted_iterator<ForwardIterator<int*>>>::value, "");
    }

    {
        eastl::list<int> l;
        counted_iterator<eastl::list<int>::iterator> a(l.begin(), 0);
        counted_iterator<eastl::list<int>::const_iterator> b(l.begin(), 0);
