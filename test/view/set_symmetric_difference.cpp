...
#include <EARanges/view/set_algorithm.hpp>
...
int main()
{
    ...
    // move
    {
        ...
        auto v0_greedy = to<eastl::vector<MoveOnlyString>>({"a","b","b","c","x","x"});
        auto v1_greedy = to<eastl::vector<MoveOnlyString>>({"b","x","y","z"});
        eastl::vector<MoveOnlyString> expected_greedy;
