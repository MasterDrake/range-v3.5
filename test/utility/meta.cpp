...
namespace tc_detail
{
    ...
    {
        return Ret{eastl::get<Ks::value>(eastl::get<Is::value>(tpls))...};
    }
}
...
void test_tuple_cat()
{
    eastl::tuple<int, short, long> t1;
    eastl::tuple<> t2;
    eastl::tuple<float, double, long double> t3;
    eastl::tuple<void *, char *> t4;

    auto x = ::tuple_cat(t1, t2, t3, t4);
    using expected_type = eastl::tuple<int, short, long, float, double, long double, void *, char *>;
    static_assert(eastl::is_same<decltype(x), expected_type>::value, "");
}

// Other misc tests
static_assert(eastl::is_same<reverse<list<int, short, double>>, list<double, short, int>>::value, "");
static_assert(eastl::is_same<reverse<list<int, short, double, float>>, list<float, double, short, int>>::value, "");
static_assert(eastl::is_same<reverse<list<int[1], int[2], int[3], int[4], int[5], int[6], int[7], int[8], int[9], int[10], int[11], int[12], int[13], int[14], int[15], int[16], int[17]>>, list<int[17], int[16], int[15], int[14], int[13], int[12], int[11], int[10], int[9], int[8], int[7], int[6], int[5], int[4], int[3], int[2], int[1]>>::value, "");

static_assert(all_of<list<int, short, long>, quote<eastl::is_integral>>::value, "");
static_assert(none_of<list<int, short, long>, quote<eastl::is_floating_point>>::value, "");
static_assert(!any_of<list<int, short, long>, quote<eastl::is_floating_point>>::value, "");
static_assert(any_of<list<int, short, long, float>, quote<eastl::is_floating_point>>::value, "");

static_assert(eastl::is_same<invoke<uncurry<curry<quote_trait<id>>>, eastl::tuple<int, short, double>>,
                           list<int, short, double>>::value,
              "");

template<typename, typename, typename = void>
struct can_invoke_ : eastl::false_type
{
};

template<typename F, typename... As>
struct can_invoke_<F, meta::list<As...>, meta::void_<meta::invoke<F, As...>>> : eastl::true_type
{
};
...
static_assert(can_invoke<meta::quote<eastl::pair>, int, int>::value, "");
// I'm guessing this failure is due to GCC #64970
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
#if !defined(__GNUC__) || defined(__clang__) || __GNUC__ >= 5
static_assert(!can_invoke<meta::quote<eastl::pair>, int, int, int>::value, "");
#endif

// Sanity-check meta::lambda
using Lambda0 = lambda<_a, _b, eastl::pair<_a, _b>>;
using Lambda1 = lambda<_a, _b, eastl::pair<_b, _a>>;
using Lambda2 = lambda<_a, _b, eastl::pair<_b, eastl::pair<_a, _a>>>;
using Pair0 = invoke<Lambda0, int, short>;
using Pair1 = invoke<Lambda1, int, short>;
using Pair2 = invoke<Lambda2, int, short>;
static_assert(eastl::is_same<Pair0, eastl::pair<int, short>>::value, "");
static_assert(eastl::is_same<Pair1, eastl::pair<short, int>>::value, "");
static_assert(eastl::is_same<Pair2, eastl::pair<short, eastl::pair<int, int>>>::value, "");
...
static_assert(
    eastl::is_same<CartProd, meta::list<meta::list<int, float>, meta::list<int, double>,
                                      meta::list<short, float>, meta::list<short, double>>>::value,
    "");

static_assert(can_invoke<lambda<_a, lazy::if_<eastl::is_integral<_a>, _a>>, int>::value, "");
// I'm guessing this failure is due to GCC #64970
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
#if !defined(__GNUC__) || defined(__clang__) || __GNUC__ >= 5
static_assert(!can_invoke<lambda<_a, lazy::if_<eastl::is_integral<_a>, _a>>, float>::value, "");
#endif

template<typename List>
using rev = reverse_fold<List, list<>, lambda<_a, _b, defer<push_back, _a, _b>>>;
static_assert(eastl::is_same<rev<list<int, short, double>>, list<double, short, int>>::value, "");

using uncvref_fn = lambda<_a, l::_t<eastl::remove_cv<l::_t<eastl::remove_reference<_a>>>>>;
static_assert(eastl::is_same<invoke<uncvref_fn, int const &>, int>::value, "");

using L = list<int, short, int, float>;
static_assert(eastl::is_same<find<L, int>, list<int, short, int, float>>::value, "");
static_assert(eastl::is_same<find_if<L, bind_front<quote<eastl::is_same>, int>>, list<int, short, int, float>>::value, "");
static_assert(eastl::is_same<find_if<L, bind_front<quote<eastl::is_same>, double>>, list<>>::value, "");
static_assert(eastl::is_same<reverse_find<L, int>, list<int, float>>::value, "");
static_assert(eastl::is_same<reverse_find_if<L, bind_front<quote<eastl::is_same>, int>>, list<int, float>>::value, "");
static_assert(eastl::is_same<reverse_find_if<L, bind_front<quote<eastl::is_same>, double>>, list<>>::value, "");
...
using find_index_ = let<
    ...
    lazy::if_<eastl::is_same<_b, list<>>, meta::npos, lazy::minus<lazy::size<_a>, lazy::size<_b>>>>;
...
template<typename T>
using test_lazy_if_ = let<lazy::if_<eastl::is_void<T>, T, defer<eastl::pair, T>>>;
static_assert(eastl::is_same<test_lazy_if_<void>, void>::value, "");

// Test that and_ gets short-circuited:
template<typename T>
using test_lazy_and_ = let<lazy::and_<eastl::is_void<T>, defer<eastl::is_convertible, T>>>;
static_assert(eastl::is_same<test_lazy_and_<int>, eastl::false_type>::value, "");

// Test that and_ gets short-circuited:
template<typename T>
using test_lazy_or_ = let<lazy::or_<eastl::is_void<T>, defer<eastl::is_convertible, T>>>;
static_assert(eastl::is_same<test_lazy_or_<void>, eastl::true_type>::value, "");
...
int main()
{
    ...
    // meta::filter
    {
        ...
        static_assert(eastl::is_same<il, meta::filter<l, meta::quote<eastl::is_integral>>>{}, "");
        static_assert(eastl::is_same<fl, meta::filter<l, meta::quote<eastl::is_floating_point>>>{}, "");
    }
    ...
    // meta::for_each
    {
        ...
        static_assert(eastl::is_same<meta::_t<eastl::remove_cv<decltype(r)>>, check_integral>::value,
                      "");
    }
    ...
    {
        using l = meta::list<int, long, short, int>;
        static_assert(meta::count_if<l, lambda<_a, eastl::is_same<_a, int>>>{} == 2, "");
        static_assert(meta::count_if<l, lambda<_b, eastl::is_same<_b, short>>>{} == 1, "");
        static_assert(meta::count_if<l, lambda<_c, eastl::is_same<_c, double>>>{} == 0, "");
    }

    // pathological lambda test
    {
        using X = invoke<lambda<_a, lambda_test<_a>>, int>;
        static_assert(eastl::is_same<X, lambda_test<_a>>::value, "");
    }

    // meta::unique
    {
        using l = meta::list<int, short, int, double, short, double, double>;
        static_assert(eastl::is_same<meta::unique<l>, list<int, short, double>>::value, "");
    }
    ...
    // lambda with variadic placeholders
    {
        ...
        static_assert(eastl::is_same<X, list<int, short, double>>::value, "");

        using X2 = invoke<lambda<_a, lambda_test<_a>>, int>;
        static_assert(eastl::is_same<X2, lambda_test<_a>>::value, "");

        using Y = invoke<lambda<_args, defer<eastl::pair, _args>>, int, short>;
        static_assert(eastl::is_same<Y, eastl::pair<int, short>>::value, "");

        using Y2 = invoke<lambda<_args, list<_args, list<_args>>>, int, short>;
        static_assert(eastl::is_same<Y2, list<int, short, list<int, short>>>::value, "");

        using Z = invoke<lambda<_a, _args, list<int, _args, double, _a>>, short *, short, float>;
        static_assert(eastl::is_same<Z, list<int, short, float, double, short *>>::value, "");

        // Nesting variadic lambdas in non-variadic lambdas:
        using A = invoke<lambda<_a, lazy::invoke<lambda<_b, _args, list<_args, _b>>, _a,
                                               lazy::_t<eastl::add_pointer<_a>>,
                                               lazy::_t<eastl::add_lvalue_reference<_a>>>>,
                        int>;
        static_assert(eastl::is_same<A, list<int *, int &, int>>::value, "");
        ...
        using B = invoke<lambda<_a, _args, lazy::invoke<lambda<_b, list<_b, _args, _a>>, _a>>, int,
                        short, double>;
        static_assert(eastl::is_same<B, list<int, short, double, int>>::value, "");
...
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
#if !defined(__GNUC__) || defined(__clang__) || __GNUC__ >= 5
        static_assert(!can_invoke<lambda<_args, defer<eastl::pair, _args>>, int>::value, "");
        static_assert(!can_invoke<lambda<_args, defer<eastl::pair, _args>>, int, short, double>::value,
                      "");
        static_assert(!can_invoke<lambda<_a, defer<eastl::pair, _a, _a>>, int, short>::value, "");
        static_assert(!can_invoke<lambda<_a, _b, _c, _args, defer<eastl::pair, _a, _a>>>::value, "");
#endif
    }
