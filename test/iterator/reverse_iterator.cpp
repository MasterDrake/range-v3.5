...
template<class It>
void test14(It i, ranges::iter_value_t<It> x)
{
    ranges::reverse_iterator<It> r(i);
    CHECK(*r == x);
}
...
void test17(It1 l, It2 r, std::ptrdiff_t x)
{
...
template<class It>
void test24(It i, ranges::iter_value_t<It> x)
{
    ranges::reverse_iterator<It> r(i);
    CHECK((*r).get() == x.get());
}
...
template<class It>
void test25(It i, ranges::iter_difference_t<It> n, It x)
{
    const ranges::reverse_iterator<It> r(i);
...
{
    {
        static_assert(ranges::detail::bidirectional_cursor<ranges::detail::reverse_cursor<BidirectionalIterator<const char *>>>, "");
        static_assert(ranges::detail::bidirectional_cursor<ranges::detail::reverse_cursor<RandomAccessIterator<const char *>>>, "");
        static_assert(ranges::detail::random_access_cursor<ranges::detail::reverse_cursor<RandomAccessIterator<const char *>>>, "");
        static_assert(ranges::bidirectional_iterator<ranges::reverse_iterator<BidirectionalIterator<const char *>>>, "");
        static_assert(ranges::random_access_iterator< ranges::reverse_iterator<RandomAccessIterator<const char *>>>, "");
    }
    { // test
    ...
    { // test3
        Derived d;
        test3<BidirectionalIterator<Base *>>(BidirectionalIterator<Derived *>(&d));
    ...
    {
        const char* s = "1234567890";
        test22(RandomAccessIterator<const char*>(s), RandomAccessIterator<const
        char*>(s), false); test22(RandomAccessIterator<const char*>(s),
        RandomAccessIterator<const char*>(s+1), false);
        test22(RandomAccessIterator<const char*>(s+1), RandomAccessIterator<const
        char*>(s), true); test22(s, s, false); test22(s, s+1, false); test22(s+1, s,
        true);
    }
    {
        const char* s = "1234567890";
        test23(RandomAccessIterator<const char*>(s), RandomAccessIterator<const
        char*>(s), true); test23(RandomAccessIterator<const char*>(s),
        RandomAccessIterator<const char*>(s+1), false);
        test23(RandomAccessIterator<const char*>(s+1), RandomAccessIterator<const
        char*>(s), true); test23(s, s, true); test23(s, s+1, false); test23(s+1, s,
        true);
    }
    {
        B a;
