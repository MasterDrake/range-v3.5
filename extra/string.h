...
namespace eastl
{
	...
	public:
		...
		template <typename Iter, typename = eastl::enable_if_t<eastl::is_same_v<typename eastl::iterator_traits<typename eastl::decay<Iter>::type>::value_type, value_type>>>
       ...
       /* template<class Iter,
                      eastl::enable_if_t<eastl::generic_iterator<Iter>, int> = 0>
        template<class Iter>
        constexpr iterator insert(const const_iterator p, const Iter pBegin, const Iter pEnd)
        {
